...
/**
 * This interface defines a fragment (a piece of a rasterized polygon covering a single pixel). A
 * fragment defines a color by which anything behind it should be multiplied, and a color which
 * should be added to anything behind it. Fragments can be chained together, when several polygons
...
public interface Fragment {
    ...
    /**
     * Get whether this fragment is completely opaque, such that anything behind it has no effect on
    ...
    /**
     * Get the depth of the frontmost opaque fragment. Anythinig beyond this depth has no effect on
     * the final color.
     */
