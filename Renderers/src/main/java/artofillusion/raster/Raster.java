...
public class Raster implements Renderer, Runnable {
    ...
    /**
     * Adjust the additive and multiplicative colors for a pixel based on the material it is passing
     * through.
     */
    ...
    /**
     * Render a single object into the scene. viewdir is the direction from which the object is
     * being viewed in world coordinates.
     */
    ...
    /**
     * Calculate the lighting model at a point on a surface. If diffuse, specular, or highlight is
     * null, that component will not be calculated.
     */
    ...
    /**
     * Render a displacement mapped triangle mesh by recursively subdividing the triangles until
    ...
    /**
     * This is an inner class for keeping track of information about vertices when doing
