...
/**
 * RTTriangleLowMemory is identical to {@link RTTriangle}, except that it precalculates less
 * information. This means that it is slightly slower, but also uses less memory.
 */
