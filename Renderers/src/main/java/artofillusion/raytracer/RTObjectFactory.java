...
/**
 * This interface defines a category of plugins that can generate RTObjects and Lights from objects
 * in the scene. As the raytracer is processing objects, it invokes each registered RTObjectFactory
 * to process each object. It stops as soon as one of them indicates that it has successfully
 * processed the object. If no factory can process the object, the raytracer generates RTObjects and
 * Lights itself in the default way.
 */
