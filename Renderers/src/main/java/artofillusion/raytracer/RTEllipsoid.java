...
/**
 * RTEllipsoid represents an ellipsoid to be raytraced. It is defined by specifying a Sphere object,
 * and the transformations to and from local coordinates.
 */
public class RTEllipsoid extends RTObject {
    ...
    /**
     * Given a point, project it onto the surface of the ellipsoid. This is necessary to prevent
     * roundoff error.
     */
