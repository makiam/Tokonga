...
/**
 * This class represents a single photon used for photon mapping. It stores the light intensity and
 * color, position, incident direction, and a flag used for building the photon map.
 *
