...
public class EllipsoidPhotonSource implements PhotonSource {
     ...
     * @param intensity the PhotonSource should generate Photons whose total intensity is
     ...
     * @param r a ray whose origin is the point from which to generate the photon (in local
     * coordinates)
