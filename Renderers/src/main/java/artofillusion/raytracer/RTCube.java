...
/**
 * RTCube represents a cube (or more generally, any rectangular box) to be raytraced. It is defined
 * by specifying a Cube object, and the transformations to and from local coordinates.
 */
public class RTCube extends RTObject {
    ...
    /**
     * Given a point, project it onto the surface of the cube. This is necessary to prevent roundoff
     * error. This routine can optionally set the true normal, since it is easy to do at the same
     * time.
     */
