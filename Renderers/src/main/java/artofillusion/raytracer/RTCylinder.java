...
/**
 * RTCylinder represents an cylinder, tapered cylinder, or cone to be raytraced. It is defined by
 * specifying a Cylinder object, and the transformations to and from local coordinates.
 */
public class RTCylinder extends RTObject {
    ...
    /**
     * Given a point, project it onto the surface of the cylinder. This is necessary to prevent
     * roundoff error.
     */
