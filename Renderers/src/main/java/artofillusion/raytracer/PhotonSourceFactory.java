...
/**
 * This interface defines a category of plugins that can generate PhotonSources from objects in the
 * scene. As the raytracer is processing RTObjects and Lights, it invokes each registered
 * PhotonSourcetFactory to process each one. It stops as soon as one of them indicates that it has
 * successfully processed the object. If no factory can process the object, the raytracer generates
 * PhotonSources itself in the default way.
 */
public interface PhotonSourceFactory {
     ...
     * this method should generate an appropriate set of PhotonSources from it and return true to
     * indicate that the object has been processed.
     *
    ...
    /**
     * This method will be invoked for each Light in the scene. If this factory can process it, this
     * method should generate an appropriate set of PhotonSources from it and return true to
     * indicate that the object has been processed.
     *
