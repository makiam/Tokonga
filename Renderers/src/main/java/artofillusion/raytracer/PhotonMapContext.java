...
/**
 * This class holds temporary information which is used while evaluating a photon map. One instance
 * of it is created for each photon map for each worker thread.
 */
