...
/**
 * A Ray is defined by two vectors: an origin and a direction. In addition, every ray has a unique
 * ID number which can be used to avoid repeated intersection tests. Call newID() to update the ID
 * number any time the ray has been modified.
 *
...
public class Ray {
    ...
    /**
     * Determine whether this ray intersects an object. This returns a SurfaceIntersection
     * describing the intersection, or SurfaceIntersection.NO_INTERSECTION if it does not intersect.
     */
