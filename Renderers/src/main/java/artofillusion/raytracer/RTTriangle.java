...
/**
 * RTTriangle represents a triangle to be raytraced. It is defined by specifying a RenderingMesh,
 * the index of the RenderingTriangle within the mesh, and a matrix which gives the transformation
 * from the mesh's local coordinates to world coordinates. To save time and memory, the constructor
 * is also passed two arrays which contain the vertices and normals for the mesh, transformed into
 * world coordinates.
 */
