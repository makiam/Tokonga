...
/**
 * A PixelInfo is used during raytracing to store information about the rays that have been sent out
 * through a particular pixel.
 */
public class PixelInfo {
    ...
    /**
     * Decide whether the color of this pixel is identical to another one, within either of the
     * specified tolerances (relative and absolute differences)
     */
