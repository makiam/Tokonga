...
/**
 * RTSphere represents a sphere to be raytraced. It is defined by specifying a Sphere object, and
 * the transformations to and from local coordinates. It must be a true sphere, not an ellipsoid.
 * That is, all of its radii must be equal.
 */
public class RTSphere extends RTObject {
    ...
    /**
     * Given a point, project it onto the surface of the sphere. This is necessary to prevent
     * roundoff error.
     */
