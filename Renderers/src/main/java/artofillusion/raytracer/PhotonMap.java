 ...
 *
 * Henrick Wann Jensen, "Realistic Image Synthesis Using Photon Mapping", A K Peters, Natick, MA,
 * 2001.
 */
public class PhotonMap {
     ...
     * @param numEstimate the number of photons to use when estimating the illumination from this
     * map
     * @param includeCaustics true if this PhotonMap should include photons that represent caustics
     * @param includeDirect true if this PhotonMap should include photons that represent direct
     * illumination
     * @param includeIndirect true if this PhotonMap should include photons that represent indirect
     * illumination
     * @param includeVolume
     ...
     * @param shared another PhotonMap with which this one may share data structures to save memory
     * (may be null)
     */
     ...
     * @param indirect specifies whether the photon's source should be treated as indirect
     * illumination
     */
     ...
     * @param caustic true if this ray has been specularly reflected or refracted since leaving the
     * eye
     */
    ...
    /**
     * Propagate a ray through a material, determine how much light is removed (due to absorption
     * and outscattering) and stored photons in the volume photon map.
     * <p>
     * On exit, rayIntensity[treeDepth] is reduced by the appropriate factor to account for the
     * absorbed light.
     *
     ...
     * volume of a sphere whose radius is given by size.
     */
     ...
     * which on exit is overwritten with the new direction. norm is the local surface normal, and
     * roughness determines how much the ray direction is altered.
     */
    ...
    /**
     * This method is called recursively to build the packed kd-tree of photons from the workspace
     * array.
     *
