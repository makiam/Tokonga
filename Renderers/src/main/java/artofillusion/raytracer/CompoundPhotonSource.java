...
/**
 * This class is a PhotonSource that simply represents a collection of other PhotonSources. It is
 * used to parallelize the generation of photons from sources that are not themselves parallelized.
 */
