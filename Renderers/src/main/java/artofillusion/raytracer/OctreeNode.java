...
/**
 * This class represents a node in an octree, used for sorting the objects by location in the scene.
 * OctreeNodes can be terminal nodes, in which case they contain a list of objects, or branch nodes,
 * in which case they contain a list of other nodes.
 * <p>
 * This class is more sophisticated than most octrees. When it subdivides a node, it does not simply
 * cut it in half along each axis. Instead, it tries to determine the optimal place to subdivide
 * along each axis, based on the bounding boxes of the objects within the node.
 */
public class OctreeNode {
    ...
    /**
     * The constructor takes a bounding box, an array of objects, an array of bounding boxes of the
     * objects, and a reference to its parent node. treeDepth is the depth of this node in the
     * octree, and maxDepth is the maximum allowed depth.
     */
    ...
    /**
     * Determine whether this node should be subdivided. If so, create the child nodes. Otherwise,
