...
/**
 * This class stores a list of photons which are close to a point in space, and calculates the
 * incident light intensity from them.
 *
...
public class PhotonList {
    ...
    /**
     * Reorder the photons to form a max heap. This means that for every photon i, dist2[i] is
     * greater than or equal to dist2[2*i+1] and dist2[2*i+2].
     */
