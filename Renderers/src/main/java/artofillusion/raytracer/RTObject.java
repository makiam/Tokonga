...
public abstract class RTObject {
    ...
    /**
     * Determine whether a ray intersects this object. In most cases, this method should not be
     * called directly. Instead, call {@link Ray#findIntersection(RTObject)} on a Ray, which
     * provides caching to avoid repeated intersection calculations.
     */
    ...
    /**
     * Get the object represented by this RTObject. The default implementation simply returns this,
     * but subclasses may override it to return something more appropriate. For example, if the
     * RTObject is a triangle in a mesh, it may return the mesh.
     */
