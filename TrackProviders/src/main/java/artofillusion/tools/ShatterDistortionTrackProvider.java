...
public class ShatterDistortionTrackProvider implements TrackProvider {
    @Override
    ...
    public String getName() {
        return Translate.text("menu.shatterDistortion");
    }

    @Override
    public void forEach(ObjectInfo item, UndoRecord undo) {
        TrackProvider.add(item, new ShatterTrack(item), undo);
    }
}
