...
public class BendDistortionTrackProvider implements TrackProvider {
    @Override
    ...
    public String getName() {
        return Translate.text("menu.bendDistortion");
    }

    @Override
    public void forEach(ObjectInfo item, UndoRecord undo) {
        TrackProvider.add(item, new BendTrack(item), undo);
    }
}
