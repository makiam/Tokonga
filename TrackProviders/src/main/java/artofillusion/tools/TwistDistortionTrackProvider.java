...
public class TwistDistortionTrackProvider implements TrackProvider {
    @Override
    ...
    public String getName() {
        return Translate.text("menu.twistDistortion");
    }

    @Override
    public void forEach(ObjectInfo item, UndoRecord undo) {
        TrackProvider.add(item, new TwistTrack(item), undo);
    }
}
