 ...
 * @author MaksK
 */
public class SkeletonShapeTrackProvider implements TrackProvider {
    ...
    public String getName() {
        return Translate.text("menu.skeletonShapeTrack");
    }

    @Override
    public void forEach(ObjectInfo item, UndoRecord undo) {
        TrackProvider.add(item, new SkeletonShapeTrack(item), undo);
    }
