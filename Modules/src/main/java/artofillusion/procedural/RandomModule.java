...
public class RandomModule extends ProceduralModule {
    ...
    /**
     * Calculate the noise function corresponding to a given input value, where fract is the
     * fractional part of the input, and calcCoefficients() has already been called with the integer
     * part.
     */
    ...
    /**
     * Calculate the derivative of the noise function corresponding to a given input value, where
     * fract is the fractional part of the input, and calcCoefficients() has already been called
    ...
    /**
     * Calculate the integral of the noise function from the start of the current unit interval,
     * where fract is the fractional part of the input, and calcCoefficients() has already been
     * called with the integer part.
     */
    ...
    /**
     * Calculate the integral of the noise function over a unit interval, where calcCoefficients()
     * has already been called with the starting point.
     */
