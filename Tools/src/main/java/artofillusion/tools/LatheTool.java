...
public class LatheTool implements ModellingTool {
     ...
     * @param segments the number of segments the lathed mesh should include. The larger this
     * number, the higher the resolution of the resulting mesh.
     * @param angle the total angle by which to rotate the curve, in degrees.
     * @param radius the radius by which to offset the rotation axis from the curve before
     * performing the lathe operation.
