...
/**
 * Parameters for creating arrays are stored in the ArraySpec class. From these parameters, an array
 * can be created.
 *
...
public class ArraySpec {
    ...
    // general paramters
    /**
     * Set to METHOD_LINEAR to create a linear array. Set to METHOD_CURVE to create an array along a
     * curve.
     */
    public int method;
    /**
    ...
    /**
     * Set to MODE_STEP to determine the number of copies from the step size. Set to MODE_COPIES to
     * use the curveCopies field explicitly
     */
    public int curveMode;
    /**
     * The number of copies to make along a curve. Only used when curveMode = CURVE_COPIES
     */
    public int curveCopies;
    /**
     * the stepsize between copies. Only used when curveMode = CURVE_COPIES
     */
    ...
    /**
     * When set, the initial position of the object is ignored. The object will pivot abouts its
     * origin instead of about a point on the path curve
     */
    public boolean ignoreOrigin;
    /**
     * When set, the initial orientation of the object is ignored. The object will have a default
     * orientation at the beginning of the path curve.
     */
    public boolean ignoreOrientation;

    // general options
    /**
     * If set, an instance of the object(s) will be created at first position of the array (linear
     * displacement 0 or the beginning of the spline curve.
     */
    ...
    private void createCurveArray() {
        ...
        if (curveMode == MODE_COPIES) {
            ...
            if (curveStep / curveLength < 0.001) {
                curveStep = 0.001 * curveLength;
            }
    ...
    /**
     * create a copy of an object and displace it. If live = true then make a live duplicate instead
     * of a copy
     */
    ...
    /**
     * create a copy of an object and place it at cs. If live = true then make a live duplicate
     * instead of a copy
     */
    ...
    /**
     * create a copy (or live duplicate) of an object, transform its coordinate system and add it to
     * the group object
     */
    ...
    /**
     * create a copy (or live duplicate) of an object, add it to and transform its coordinate
     * system.
     */
    ...
    /**
     * determines a point on the curve for which the distance to the first point is given by
     * relativePosition
     */
    ...
    /**
     * Construct the Minimally Rotating Frame at every point along the path. sets values in zdir[]
     * and updir[] reused code from Peter Eastman's Extrude Tool
     */
    ...
    /**
     * determines the coordinatesystem that specifies position and orienation vectors at the point
     * on the curve for which the distance to the first point is given by relativePosition
     */
