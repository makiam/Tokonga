...
public class TextTool implements ModellingTool {
     ...
     * @param thickness if type is Tube, the thickness of the Tube objects to create. If type is
     * Solid, the thickness of the extruded letters.
     * @param texture the texture to assign to the created objects (ignored if type is Outline,
     * since then the objects are Curves)
