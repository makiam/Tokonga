...
/**
 * ----------------------------------------------------------------------------- The following
 * example implements a class for encrypting and decrypting strings using several Cipher algorithms.
 * The class is created with a key and can be used repeatedly to encrypt and decrypt strings using
 * that key. Some of the more popular algorithms are: Blowfish DES DESede PBEWithMD5AndDES
 * PBEWithMD5AndTripleDES TripleDES
 * -----------------------------------------------------------------------------
 *
 * @author not me ! See http://www.idevelopment.info/, which hase several java code examples
