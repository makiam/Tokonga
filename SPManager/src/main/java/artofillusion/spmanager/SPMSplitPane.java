...
public class SPMSplitPane extends BSplitPane {
    ...
    /**
     * This class superimposes an icon over an original icon. It is used to display a checkmark over
     * file icons in the scripts & plugins tree
     *
     * @author francois
