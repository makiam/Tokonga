...
public class SPManagerUtils {
    ...
    /**
     * Gets a named node from a node list. Returns null if the node does not exist.
     *
     ...
     *
     * The string is parsed from the first (zeroeth) char up to the first char which is not valid in
     * a double representation (ie digit, '.', 'e', 'E', '+', or '-').
     */
     ...
     *
     * Each component is parsed as an int and scaled into a 3-digit column.
