...
public class SPMObjectInfo {
     ...
     *
     * Either <i>lhs</i> or <i>rhs</i> may include a boolean operator, otherwise <i>equals</i> is
     * assumed. If <i>both</i> lhs and rhs contain a boolean operator, then the one on rhs is used.
     *
     * @param lhs the left-hand-side of the test. May contain a trailing boolean operator.
     * <br>Eg: "Fred", "Fred=", "100&gt;=", "Fred+="
     *
     * @param rhs the right-hand-side of the test. May contain a leading boolean operator, or a
     * trailing range indicator.
