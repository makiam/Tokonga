...
/**
 * This class holds unfolded meshes and UV mapping editor information for saving into AoI files and
 * future reuse.
 *
...
public class UVMappingData {
    ...
    /**
     * Creates a mapping from default vertices positions or from an existing mapping vertices
     * positions
     *
     * @param name The name of the new mapping
     * @param dupMapping Mapping to duplicate vertices positions from. May be null in which case
