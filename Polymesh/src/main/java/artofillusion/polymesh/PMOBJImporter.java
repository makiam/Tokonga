/*
 *  Copyright (C) 2002,2004 by Peter Eastman, Modifications (C) 2005 by Fran?ois Guillet for PolyMesh adaptation
...
public class PMOBJImporter {
    ...
    /**
     * Parse the specification for a vertex and return the index of the vertex to use.
     *
    ...
    private static class TextureInfo {
        ...
        /**
         * This should be called once, after the TextureInfo is created but before it is actually
         * used. It converts from the representation used by .obj files to the one used by Art of
         * Illusion.
         */
