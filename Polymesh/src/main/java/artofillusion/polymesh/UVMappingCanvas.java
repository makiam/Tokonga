...
public class UVMappingCanvas extends CustomWidget {
     ...
     */
    /**
     * The widget dimension adapts itself to the current size except if it's too small
     */
    @Override
    ...
    /**
     * Draws the mesh pieces, either in the current canvas or for export purposes
     *
    ...
    /**
     * Sets the current drag box and repaints the mesh. Set the drag box to null in order to stop
     * the drag box display.
     *
    ...
    /**
     * Sets the positions of vertices relative to view window (not to UV values). If mask is not
     * null, change is applied only for points for which mask is true.
     *
     * @param newPos
     * @param mask
     */
    ...
    /**
     * This function returns the rectangle that encloses the mesh, taking into accout mesh origin,
    ...
    /**
     * Given the index of a displayed vertex, returns the index of this vertex with respect to the
     * unfolded piece of mesh.
     *
     * This comes form the fact that not all vertices are displayed when the original mesh is not a
     * triangle mesh
     *
