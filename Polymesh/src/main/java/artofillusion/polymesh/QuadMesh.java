...
public class QuadMesh extends Object3D implements FacetedMesh {
     ...
     * "first" edge. Vertices also have a smoothness parameter associated to it : a vertex can be a
     * smooth vertex, a crease or a corner. A vertex also has a "smoothness" parameter associated
     * with it.
     */
    ...
    /**
     * A face is defined by its four vertices and four edges. The vertices must be arranged in
     * counter-clockwise order, when viewed from the outside. Edges 1, 2, 3 and 4 connect vertices 1
     * and 2, 2 and 3, 3 and 4, and 4 and 1 respectively.
     */
...
//		}
    ...
    /**
     * Returns the edges aroun a given vertex, ordered Ordering can be clockwise or anti-clockwise
     *
     * @param v The vertex to find edges for
     * @return The edges array
     */
