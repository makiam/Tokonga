...
public abstract class AdvancedEditingTool extends EditingTool {
    ...
    /**
     * Call this method when the selection mode has changed Depending on the tool specialization,
     * display can be updated depending on the selection mode (whatever the mode really, e.g. face,
     * edge, vertex mode for meshes, etc.
     */
