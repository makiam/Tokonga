...
public class PolyMeshEditorWindow extends MeshEditorWindow implements PopupMenuManager, ValueWidgetOwner {
    ...
    private BMenuItem meshUnfold;
    private BMenuItem editMapping;
    ...
    void createEdgeMenu() {
        ...
        BMenu menuItem = (BMenu)edgeMenuItem[2];
        menuItem.add(extrudeEdgeItem = Translate.menuItem("polymesh:extrudeNormal", this, "doExtrudeEdgeNormal"));
        menuItem.add(Translate.menuItem("polymesh:xExtrude", this, "doExtrudeEdgeXAxis"));
        menuItem.add(Translate.menuItem("polymesh:yExtrude", this, "doExtrudeEdgeYAxis"));
        menuItem.add(Translate.menuItem("polymesh:zExtrude", this, "doExtrudeEdgeZAxis"));
        ...
        menuItem = (BMenu)edgeMenuItem[8];
        menuItem.add(Translate.menuItem("polymesh:all", this, "doSelectRingAll"));
        menuItem.add(Translate.menuItem("polymesh:two", this, "doSelectRingTwo"));
        menuItem.add(Translate.menuItem("polymesh:three", this, "doSelectRingThree"));
        menuItem.add(Translate.menuItem("polymesh:four", this, "doSelectRingFour"));
        menuItem.add(Translate.menuItem("polymesh:five", this, "doSelectRingFive"));
        menuItem.add(Translate.menuItem("polymesh:specify", this, "doSelectRingInteractive"));
        ...
        menuItem = (BMenu)edgePopupMenuItem[2];
        menuItem.add(Translate.menuItem("polymesh:extrudeNormal", this, "doExtrudeEdgeNormal"));
        menuItem.add(Translate.menuItem("polymesh:xExtrude", this, "doExtrudeEdgeXAxis"));
        menuItem.add(Translate.menuItem("polymesh:yExtrude", this, "doExtrudeEdgeYAxis"));
        menuItem.add(Translate.menuItem("polymesh:zExtrude", this, "doExtrudeEdgeZAxis"));
        ...
        menuItem = (BMenu)edgePopupMenuItem[8];
        menuItem.add(Translate.menuItem("polymesh:all", this, "doSelectRingAll"));
        menuItem.add(Translate.menuItem("polymesh:two", this, "doSelectRingTwo"));
        menuItem.add(Translate.menuItem("polymesh:three", this, "doSelectRingThree"));
        menuItem.add(Translate.menuItem("polymesh:four", this, "doSelectRingFour"));
    ...
    void createTextureMenu() {
        ...
        textureMenu.add(meshUnfold = Translate.menuItem("polymesh:unfoldMesh", this, "doUnfoldMesh"));
        textureMenu.add(editMapping = Translate.menuItem("polymesh:editMapping", this, "doEditMapping"));
    }
    ...
    private void doSelectRing(int every) {
        PolyMesh mesh = (PolyMesh) objInfo.object;
        boolean[] ring = mesh.findEdgeStrips(selected, every);
        if(null == ring) return;
        setSelection(ring);
    }
    
    @SuppressWarnings("unused")
    private void doSelectRingAll() {
        doSelectRing(1);
    }
    
    @SuppressWarnings("unused")
    private void doSelectRingTwo() {
        doSelectRing(2);
    }
    
    @SuppressWarnings("unused")
    private void doSelectRingThree() {
        doSelectRing(3);
    }
    
    @SuppressWarnings("unused")
    private void doSelectRingFour() {
        doSelectRing(4);
    }
    
    private void doSelectRingFive() {
        doSelectRing(5);
    }
    ...
    /**
     * Determine which edge of the control mesh corresponds to each edge of the subdivided mesh. If
     * the control mesh is not being projected onto the surface, this returns null.
     */
    ...
    public void updateMenus() {
        ...
        editMapping.setEnabled(null != mesh.getMappingData());
        ...
        if (mesh.isClosed()) {
            ...
            meshUnfold.setEnabled(null != mesh.getSeams());
    ...
    /**
     * Gets the selected points, edges or faces as an integer array given the boolean selection
     * array
     *
...
//			smoothItem[1].setState(true);
    ...
    /**
     * Callback called when the valueWidget.getValue() has changed in the valueWidget.getValue()
     * dialog
     */
    ...
    public void prepareToShowValueWidget() {
        priorValueMesh = ((PolyMesh) objInfo.object).duplicate();
    ...
    private void doExtrudeEdgeXAxis() {
        if(valueWidget.isActivated()) return;
        direction = Vec3.vx();
        valueWidget.activate(this::doExtrudeEdgeCallback);
    }

    private void doExtrudeEdgeYAxis() {
        if(valueWidget.isActivated()) return;
        direction = Vec3.vy();
        valueWidget.activate(this::doExtrudeEdgeCallback);
    }

    private void doExtrudeEdgeZAxis() {
        if(valueWidget.isActivated()) return;
        direction = Vec3.vz();
        valueWidget.activate(this::doExtrudeEdgeCallback);
    }
    ...
    /**
     * Brings selected vertices to the mean sphere calculated from these vertices
     */
    ...
    /**
     * Get the extra texture parameter which was added the mesh to keep track of which faces are
     * hidden.
     *
    ...
    /**
     * Get an array of flags telling which parts of the mesh are currently selected. Depending on
     * the current selection mode, these flags may correspond to vertices, edges or faces.
     *
    ...
    /**
     * Get the extra texture parameter which was added to the mesh to keep track of face indices in
     * the editor.
     */
    @Override
    ...
    /**
     * Add extra texture parameters to the mesh which will be used for keeping track of face and
     * vertex indices.
     */
    ...
    /**
     * Remove the extra texture parameters from the mesh which were used for keeping track of face
     * and vertex indices.
     */
    ...
    /**
     * Selects complete boundaries based on vertex or edge selection. If selection is empty, then
     * all boundaries are selected.
     */
    ...
    /**
     * Joins boundaries, each one of the two being identified by a selected vertex
     */
    ...
    private void doCopy() {
        clipboardMesh = ((PolyMesh) objInfo.object).duplicate();
        int selCount = 0;
    ...
    private void skeletonDetachedChanged() {
        for(ViewerCanvas theView1: theView) {
            ((PolyMeshViewer) theView1).setSkeletonDetached(((BCheckBoxMenuItem) skeletonMenuItem[5]).getState());
        }
    }
    ...
    private void doEditMapping() {
        ...
        new UVMappingEditorDialog(Translate.text("uvCoordsTitle"), info, true, this);
    }
    ...
    private class SubdivisionDialog extends BDialog {
        ...
        public SubdivisionDialog(BFrame parent) {
            ...
            try(InputStream is = getClass().getResource("interfaces/subdivision.xml").openStream()) {
                WidgetDecoder decoder = new WidgetDecoder(is);
