...
public abstract class Manipulator extends EventSource {
    ...
    /**
     * Sets the manipulator bounds on screen, for example after user sets a new selection. Some
     * manipulators rely on bounds being non null to show up.
     *
    ...
    /**
     * Returns the manipulator bounds, as previously calculated after a call to setBounds(). This
     * bounds are inset by an amount of MARGIN.
     *
    ...
    /**
     * Sets the activate/inactive status of the manipulator. Inactive manipulators don't show up on
     * the views until activated again.
     *
     * @param active
     */
    ...
    /**
     * tells the manipualtor to change the view mode if it features several view modes (e.g. 3D
     * manipulator)
     */
