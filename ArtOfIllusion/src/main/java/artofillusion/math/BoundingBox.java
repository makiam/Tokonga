...
public class BoundingBox {
    ...
    /**
     * This method applies a transformation matrix M to each of the eight corners of the box, then
     * generates a new BoundingBox which is large enough to contain the transformed box.
     */
