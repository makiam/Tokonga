...
/**
 * The RGBColor class is used to represent a color. This class uses floating point numbers (usually
 * between 0 and 1) to store the red, green, and blue components, in contrast to java.awt.Color
 * which uses integers.
 */
public class RGBColor {
    ...
    /**
     * Set this color based on values in the HSV color model. This routine is based on sample code
     * given in "Computer Graphics: Principles and Practice, 2nd Edition", by Foley, van Dam, Feiner
     * and Hughes, 1997.
     */
    ...
    /**
     * Get a representation of this color in the HSV color model. This routine is based on sample
     * code given in "Computer Graphics: Principles and Practice, 2nd Edition", by Foley, van Dam,
     * Feiner and Hughes, 1997.
     */
    ...
    /**
     * Set this color based on values in the HLS color model. This routine is based on sample code
     * given in "Computer Graphics: Principles and Practice, 2nd Edition", by Foley, van Dam, Feiner
     * and Hughes, 1997. (A bug in their HLS to RGB routine has been corrected.)
     */
    ...
    /**
     * Get a representation of this color in the HLS color model. This routine is based on sample
     * code given in "Computer Graphics: Principles and Practice, 2nd Edition", by Foley, van Dam,
     * Feiner and Hughes, 1997.
     */
