...
/**
 * This class provides an implementation of Steven Worley's cellular texture basis function as
 * described in
 * <p>
 * Worley, S. "A Cellular Texture Basis Function." Siggraph Proceedings, pp. 291-294, 1996.
 * <p>
 * This function scatters "feature points" at random locations throughout 3D space. At any point (x,
 * y, z), it defines the function f1(x, y, z) to be the distance to the nearest feature point. It
 * similarly defines f2(x, y, z) as the distance to the second nearest feature point, and similarly
 * for f3(x, y, z), etc.
 */
public class Cells {
    ...
    /**
     * Get which distance metric is being used. Allowed values are EUCLIDEAN, CITY_BLOCK, or
     * CHESS_BOARD.
     */
    ...
    /**
     * Calculate the various functions at a specified point. The number of functions to evaluate is
     * determined by the length of value[]. The values of the functions are returned in value[], and
     * their gradients in grad[]. A "unique identifier" for the nearest, second nearest, etc.
     * feature point is returned in id. If gradients are not needed, null may be passed for grad[].
     */
    ...
    /**
     * Given the vector between two points, calculate the distance measure for the desired metric.
     */
