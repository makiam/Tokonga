...
/**
 * This class provides an implementation of Ken Perlin's noise function, based on the description
 * (but not on the sample code) in "Texturing &amp; Modeling: A Procedural Approach" (second
 * edition), by Ebert, Musgrave, Peachey, Perlin, and Worley (Academic Press, 1998). It also
 * includes the improvements described in "Improving Noise", by Ken Perlin, published in the 2002
 ...
 * <p>
 * Note: it is generally recommended to use {@link SimplexNoise} instead of this class, since it is
 * faster and produces more isotropic noise. Alternatively, use the {@link Noise} class, which
 * allows the preferred noise generator to be changed.
 */
public class PerlinNoise {
     ...
     * This is necessary when using noise for bump mapping.
     */
    ...
    /**
     * Given a point (x,y,z) in 3D space, set v to the value of the vector noise function at that
     * point.
     */
