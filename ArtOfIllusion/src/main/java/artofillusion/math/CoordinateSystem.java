...
/**
 * The CoordinateSystem class describes the position and orientation of one coordinate system
 * relative to another one. It is defined by three vectors. orig defines the position of the origin
 * of the new coordinate system, while zdir and updir define the directions of the z and y axes,
 * respectively. (Note that the y axis will only be parallel to updir in the special case that zdir
 * and updir are perpendicular to each other.) Alternatively, the orientation can be represented by
 * three rotation angles about the (global) x, y, and z axes. Both representations are maintained
 * internally.
 */
public class CoordinateSystem {
     ...
     * @param updir defines the "up" direction. If this is perpendicular to zdir, this will be the y
     * axis direction of the new coordinate system.
     */
    ...
    /**
     * Get the vector used to define "up" in this CoordinateSystem (usually but not always the y
     * axis direction).
     */
    ...
    /**
     * Return a matrix which will transform points from the outside coordinate system to this local
     * coordinate system.
     */
    ...
    /**
     * A rotation can also be described by specifying a rotation axis, and a rotation angle about
     * that axis. This method calculates this alternate representation of the to-local rotation. The
     * from-local transformation is found by simply reversing the sign of the rotation angle. It
     * returns the rotation angle, and overwrites axis with a unit vector along the rotation axis.
     */
