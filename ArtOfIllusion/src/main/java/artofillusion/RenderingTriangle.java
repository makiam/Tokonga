...
/**
 * A RenderingTriangle represents a triangle which is to be rendered to the screen. This is an
 * abstract class, whose subclasses provide details about how the triangle should be displayed.
 * Every RenderingTriangle is associated with a RenderingMesh. The vertices of the triangle are
 * specified as indices into the RenderingMesh's array of vertices. Similarly, the normals are
 * specified as indices into the array of normals.
 */
public abstract class RenderingTriangle implements Cloneable {
    ...
    /**
     * Given the barycentric coordinates for a point in the triangle, build a TextureSpec describing
     * the properties of the triangle at that point. The properties should be averaged over a region
     * of width size.
     */
    ...
    /**
     * Set the mesh that this triangle is part of. This is automatically called when the triangle is
     * added to the mesh.
     *
    ...
    /**
     * Given the barycentric coordinates for a point in the triangle, calculate the values of the
     * texture parameters at that point. If parameters have not been set for the rendering mesh this
     * triangle belongs to, this returns null.
     */
