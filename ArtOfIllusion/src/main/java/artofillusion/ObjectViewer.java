...
/**
 * The ObjectViewer class is the abstract superclass of components which display a single object and
...
public abstract class ObjectViewer extends ViewerCanvas {
    ...
    /**
     * Get the coordinate system in which the object is displayed. This will vary depending on
     * whether the user has selected Local or Scene coordinates.
     */
    ...
    /**
     * Begin dragging a selection region. The variable square determines whether the region should
     ...
     * <p>
     * The selection intersects the line if either:<ul>
     * <li> one of the points is inside the selection;
     * <li> both points are outside and the line formed by them intersects any of the boundaries of
     * the selection.
     * </ul>
     */
