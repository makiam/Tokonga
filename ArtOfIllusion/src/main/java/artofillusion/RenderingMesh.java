...
/**
 * A RenderingMesh represents an object to be rendered to the screen. It is described by an array of
 * RenderingTriangles, and arrays describing the positions, normals, and parameter values of the
 * vertices. If any normal vector is null, then each triangle uses its own normal vector at the
...
public class RenderingMesh implements Cloneable {
     ...
     * vertex indices for all the faces in a form suitable for passing to glDrawElements().
