...
/**
 * This class describes a parameter which affects the appearance of an object, and can vary over the
 * object's surface. Every parameter is described by a name, the Texture which it belongs to, and
...
public class TextureParameter {
    ...
    /**
     * Create a TextureParameter which is a duplicate of an existing one, but with a different
     * owner.
     */
    ...
    /**
     * Get a Widget which can be used to select a value for this parameter. This means either a
     * ValueSlider (if the parameter has a finite range), or a ValueField with appropriate
     * constraints set (if the range is unbounded on either end).
     */
