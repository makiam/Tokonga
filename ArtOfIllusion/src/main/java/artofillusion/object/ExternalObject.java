...
public class ExternalObject extends ObjectWrapper {
    ...
    /**
     * Get an error message which describes why the object could not be loaded, or null if it was
     * loaded successfully.
     */
    ...
    /**
     * Recreate an ExternalObject by reading in the serialized representation written by
     * writeToFile().
     */
