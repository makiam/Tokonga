 ...
 * Typically, these objects are procedurally generated, such as by a script.
 */
public abstract class ObjectCollection extends Object3D {
    ...
    /**
     * Get an enumeration of ObjectInfos listing the objects which this object is composed of. This
     * calls the protected method enumerateObjects() (which must be provided by subclasses), while
     * applying Distortions and caching objects for interactive previews.
     */
    ...
    /**
     * Since object collections are generally procedurally generated, they may depend explicitly on
     * time. If so, this should be called with the value true.
     */
    ...
    /**
     * Since object collections are generally procedurally generated, they may depend explicitly on
     * position. If so, this should be called with the value true.
     */
    ...
    /**
     * Assume that a material can be set for the	object collection (though actually setting one may
    ...
    /**
     * An object collection is never drawn directly. Instead, its component objects are enumerated
    ...
    /**
     * If this object explicitly references time or position, the cached objects and bounding box
