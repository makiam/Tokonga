...
/**
 * DirectionalLight represents a distant light source which emits light in one direction from
 * outside the scene.
 */
public class DirectionalLight extends Light {
    ...
    /**
     * Directional lights are not attenuated with distance, since the light source is far outside
     * the scene.
     */
    @Override
