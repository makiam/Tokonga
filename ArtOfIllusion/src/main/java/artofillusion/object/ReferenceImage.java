...
/**
 * A ReferenceImage is an object that displays an image for use during modelling. When drawn in a
 * ViewerCanvas, it is a rectangle with the image mapped to it, but when rendered by a Renderer, it
 * is invisible.
 */
