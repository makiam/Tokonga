...
/**
 * The Cylinder class represents cylinders and cones. It is specified by the height, the radii along
 * the two axes of its base, and the ratio of the top and bottom radii.
 */
public class Cylinder extends Object3D {
    ...
    /**
     * Get the allowed range for graphable values for keyframes returned by getPoseKeyframe(). This
     * returns a 2D array, where elements [n][0] and [n][1] are the minimum and maximum allowed
     * values, respectively, for the nth graphable value.
     */
