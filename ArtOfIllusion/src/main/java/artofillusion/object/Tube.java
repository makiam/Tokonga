...
/**
 * Tube represents a "thick" curve. It subclasses Curve, since it has all the properties of a an
 * ordinary curve, but changes the way it is rendered. The actual surface is created by extruding a
 * circular profile along the curve. The thickness of the Tube can be specified at each vertex.
 */
public class Tube extends Curve {
    ...
    /**
     * Set the ends style. This should be one of the following values: OPEN_ENDS, CLOSED_ENDS, or
     * FLAT_ENDS.
     */
    ...
    /**
     * Make sure the ends style is consistent with the closed flag. Generally, setEndsStyle() should
    ...
    /**
     * This is a utility routine used by both getRenderingMesh() and convertToTriangleMesh(). It
     * subdivides the surface and fills in the vectors with lists of vertices, normals, faces, and
     * parameter values.
     */
    ...
    /**
     * Tubes cannot be keyframed directly, since any change to mesh topology would cause all
    ...
    public static class TubeKeyframe extends MeshGesture {
         ...
         * or three others. These methods should never be called, since Tubes can only be keyframed
