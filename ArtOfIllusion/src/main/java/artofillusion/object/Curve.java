...
/**
 * The Curve class represents a continuous curve defined by a series of control vertices. It may be
 * either open or closed, and may either interpolate or approximate the control vertices. There is
 * also a smoothness parameter associated with each vertex.
 */
public class Curve extends Object3D implements Mesh {
    ...
    /**
     * Return a new Curve object which has been subdivided once to give a finer approximation of the
     * curve shape.
     */
    ...
    /**
     * Return a new Curve object which has been subdivided the specified number of times to give a
     * finer approximation of the curve shape.
     */
    ...
    /**
     * The following two routines are used by subdivideCurve to calculate new point positions for
     * interpolating and approximating subdivision. v is the array of current points, s is the array
     * of smoothness values for them, and i, j, k, and m are the indices of the points from which
     * the new point will be calculated.
     */
    ...
    /**
     * This is used by the above method. Given the list of remaining vertices, it finds the edges to
     * either size of the specified vertex and returns their cross product. This tells which way a
     * triangle centered at the vertex will face.
     */
    ...
    /**
     * This is used by convertToTriangleMesh. Given the list of remaining vertices, it determines
     * whether a triangle centered at the specified vertex would contain any other vertices.
     */
    ...
    /**
     * Curves cannot be keyframed directly, since any change to mesh topology would cause all
    ...
    public static class CurveKeyframe extends MeshGesture {
         ...
         * or three others. These methods should never be called, since Curves can only be keyframed
         * by converting them to Actors.
         */
        @Override
