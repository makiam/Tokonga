...
/**
 * ObjectInfo represents information about an object within a Scene: its position, orientation,
 * name, visibility, etc. The internal properties (i.e. geometry) of the object are defined by the
 * "object" property.
 * <p>
 * There may be several ObjectInfos in a scene which all reference the same Object3D. In that case,
 * they are live duplicates of each other.
 */
public class ObjectInfo {
    ...
    /**
     * Create a new ObjectInfo which is identical to this one. It will still reference the same
     * Object3D object, but all other fields will be cloned.
     */
    ...
    /**
     * Given an array of ObjectInfos, duplicate all of them (including the objects they point to),
     * keeping parent-child relationships intact.
     */
    ...
    /**
     * Make this ObjectInfo identical to another one. Both ObjectInfos will reference the same
     * Object3D object, but all other fields will be cloned.
     */
    ...
    /**
     * Add a Distortion to apply to the object. Any other Distortions which have previously been
     * added will be applied before this one.
     */
    ...
    /**
     * Set the current Distortion applied to this object. Any previously applied Distortion is
     * discarded.
     */
    ...
    /**
     * Get a new object which has had the distortion applied to it. If there is no distortion, this
     * simply returns the original object.
     */
    ...
    /**
     * Get a bounding box for the object. The bounding box is defined in the object's local
     * coordinate system.
     */
