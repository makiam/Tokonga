...
public class TriangleMesh extends Object3D implements FacetedMesh {
    ...
    private static final double[] LOOP_BETA;
    private static final double[][] BUTTERFLY_COEFF;
    ...
    public static TriangleMesh subdivideButterfly(TriangleMesh mesh, boolean[] refineEdge, double tol) {
        ...
        double[] s2;
        double[] s3;
        double[] edgeSmoothness;
        double[] vertSmoothness;
        double[] coeff;
        boolean[] refineVert;
        boolean[] notconverged;
        boolean[] regular;
    ...
    private static double[] getButterflyCoeff(int numEdges) {
        ...
        double beta = 2.0 * Math.PI / numEdges;
        coeff[numEdges] = 1.0;
