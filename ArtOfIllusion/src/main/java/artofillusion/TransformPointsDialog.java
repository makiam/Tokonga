...
/**
 * This class implements the dialog box which is used for the "Transform Points" command. It allows
 * the user enter values by which to translate, rotate, and scale the selected Points. It also
 * allows them to specify whether the rotation and scaling should be done with respect to the origin
 * of object coordinates, or the center of the selected points.
 */
