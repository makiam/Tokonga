 ...
 * properties are defined by a nonlinear mapping of a Texture2D. It stores a 3D "intermediate
 * texture coordinate" for each vertex. To find the surface properties at a given point, it linearly
 * interpolates to find the intermediate texture coordinate at that point, then calls the
 * NonlinearMapping2D object to determine the final 2D texture coordinate and get the surface spec.
 */
