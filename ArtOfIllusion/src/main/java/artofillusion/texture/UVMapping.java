...
/**
 * UVMapping is a Mapping2D which allows the user to specify the texture coordinates of each vertex
 * by hand.
 */
public class UVMapping extends Mapping2D {
    ...
    /**
     * This method should not generally be called. The mapping is undefined without knowing the
     * texture coordinates for a particular triangle.
     */
    @Override
    ...
    /**
     * Given a Mesh to which this mapping has been applied, return the texture coordinates at each
     * vertex.
     */
    @Override
    ...
    /**
     * Given an object to which this mapping has been applied and the desired texture coordinates at
     * each vertex, set the texture parameters accordingly.
     */
     ...
     * {@link #setTextureCoordinates(artofillusion.object.Object3D, artofillusion.math.Vec2[])}
     ...
     * since the LayeredMapping will have created new parameters that must be used in place of the
     * original ones.
     */
    ...
    /**
     * Given a triangle mesh to which this mapping has been applied and the desired texture
     * coordinates at each vertex, set the texture parameters accordingly. uv is an array of size [#
     * faces][# vertices/face] containing the face-vertex texture coordinates.
     */
     ...
     * <p>
     * In most cases, you can call
     * {@link #setFaceTextureCoordinates(artofillusion.object.Object3D, artofillusion.math.Vec2[][])}
     * instead, since the mapping already knows what parameters correspond to the U and V
     * coordinates. This version is necessary when this mapping is part of a {@link LayeredMapping},
     * since the LayeredMapping will have created new parameters that must be used in place of the
     * original ones.
