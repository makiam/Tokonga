...
/**
 * Texture2D represents a Texture whose surface properties are defined in 2D. This 2D surface can be
 * mapped onto a 3D object by a variety of different mappings.
 */
public abstract class Texture2D extends Texture {

    /**
     * Get the surface properties at point in the texture. The properties should be averaged over a
    ...
    /**
     * Create an Image which represents a particular component of this texture. The arguments
     * specify the region of the texture to represent (U and V ranges), the image size, the
     * component to represent (one of the constants defined in the Texture class), and the time and
     * texture parameters.
     */
