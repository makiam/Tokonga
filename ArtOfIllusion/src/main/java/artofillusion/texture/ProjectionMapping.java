...
public class ProjectionMapping extends Mapping2D {
    ...
    /**
     * Get the list of texture parameters associated with this mapping and its texture. That
     * includes the texture's parameters, and possibly parameters for the texture coordinates.
     */
    @Override
