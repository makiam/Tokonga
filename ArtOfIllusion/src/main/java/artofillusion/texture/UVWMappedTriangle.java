...
/**
 * UVWMappedTriangle is a subclass of RenderingTriangle, which represents a triangle whose 3D
 * texture coordinates are explicitly specified at each vertex.
 */
public class UVWMappedTriangle extends RenderingTriangle {
    ...
    /**
     * Create a new UVMappedTriangle. The triangle will not be fully initialized and should not be
     * used until setParameters() has been called on it.
     */
