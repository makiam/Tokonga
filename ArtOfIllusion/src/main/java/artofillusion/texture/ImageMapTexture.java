...
public class ImageMapTexture extends Texture2D {
    ...
    private class Editor extends BDialog {
        ...
        final Widget transPanel;
        final Widget specPanel;
        final Widget shinPanel;
        final Widget roughPanel;
        final Widget cloudPanel;
        final Widget bumpPanel;
        final Widget displacePanel;
        final Widget diffColorPanel;
        final Widget specColorPanel;
        final Widget transColorPanel;
        final Widget emissColorPanel;
        final BCheckBox tileXBox;
        final BCheckBox tileYBox;
        final BCheckBox mirrorXBox;
        final BCheckBox mirrorYBox;
        final MaterialPreviewer preview;
        final ActionProcessor renderProcessor;
        final ImageMapTexture newTexture;
        final Scene scene;
