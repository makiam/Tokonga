...
/**
 * LayeredMapping is the TextureMapping corresponding to LayeredTextures. It allows multiple
 * textures to be layered on top of each other. Most of the actual work is done by this class,
 * rather than LayeredTexture.
 */
public class LayeredMapping extends TextureMapping {
     ...
     * component Textures and TextureMappings. This is necessary because a single Texture might be
     * used for multiple layers, so there must be multiple parameters corresponding to each
     * parameter of that Texture.
     *
     ...
     * @return the parameter of this LayeredMapping corresponding to the specified parameter, or
     * null if the specified parameter does not belong to the Texture or TextureMapping of the
     * specified layer
     */
     ...
     * Add a layer to the texture.
     *
     * @param index the position at which the new layer should be added, where layer 0 is the
     * topmost layer (the one visible over all others)
    ...
    /**
     * Loading and saving of layered mappings works a bit differently from other mappings, since it
     * needs to refer other textures in the scene.
     */
    ...
    /**
     * Estimate the average surface properties by adding up the average properties of all of the
     * layers.
     */
    ...
    /**
     * There is no editing panel for layered mappings, since this is handled directly by the object
     * texture dialog.
     */
    @Override
