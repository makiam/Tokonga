...
/**
 * A Texture represents a description of the surface properties of an object: color, transparency,
 * displacement, etc. This is distinct from the interior bulk properties, which are described by a
 * Material object.
 */
public abstract class Texture {
    ...
    /**
     * Get the name of this type of texture. Subclasses should override this method to return an
     * appropriate name.
     */
    ...
    /**
     * Return true if this Texture makes use of the specified ImageMap. Textures which use ImageMaps
    ...
    /**
     * Get a TextureSpec which represents the average surface properties of this texture. It will be
     * used by Renderers and Translators which do not support the given texture type. This need not
     * be an exact mathematical average, but should give a reasonable representation of the overall
     * surface properties.
     */
    ...
    /**
     * Allow the user to interactively edit the texture. parent is a WindowWidget which can be used
     * as a parent for Dialogs, and sc is the Scene which this Texture is part of. Subclasses should
     * override this to implement editing.
     */
    public void edit(WindowWidget parent, Scene sc) {
    }

    /**
     * This exists only for backward compatibility. Subclasses should override the version that
     * takes a WindowWidget instead.
     */
    @Deprecated
