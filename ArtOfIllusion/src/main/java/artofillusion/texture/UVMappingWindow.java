...
public class UVMappingWindow extends BDialog implements MeshEditController, EditingWindow {
    ...
    /**
     * Get the Frame for this EditingWindow: either the EditingWindow itself if it is a Frame, or
     * its parent if it is a Dialog.
     */
    @Override
    ...
    /**
     * This will be called whenever the selection changes, so rebuild the mesh and update the text
     * fields.
     */
    @Override
