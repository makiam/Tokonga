 ...
 * coordinates and 3D space. When called on to map a triangle, it first performs any initial linear
 * transformations on the triangle vertices to yield 3-dimensional "intermediate texture
 * coordinates." It then provides a callback function which takes an intermediate texture coordinate
 * and performs the final nonlinear mapping to yield a 2D texture coordinate.
 */
public abstract class NonlinearMapping2D extends Mapping2D {
    ...
    /**
     * Given intermediate texture coordinates, find the surface properties. size is the width of the
     * area over which the properties should be averaged.
     */
    ...
    /**
     * Determine whether this texture is bound to the surface (texture coordinates are determined by
     * parameters, not by position).
     */
    ...
    /**
     * Set whether this texture is bound to the surface (texture coordinates are determined by
     * parameters, not by position).
     */
