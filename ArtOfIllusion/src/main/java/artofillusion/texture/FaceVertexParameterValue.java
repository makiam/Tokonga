...
/**
 * This class defines a scalar parameter whose value is defined at each vertex of each face of a
 * mesh.
 */
public class FaceVertexParameterValue implements ParameterValue {
    ...
    /**
     * Create a new FaceVertexParameterValue object. val is an array containing the parameter value
     * at every vertex of every face. Specifically, val[i][j] is the value at the j'th vertex of the
     * i'th face.
     */
    ...
    /**
     * Create a new FaceVertexParameterValue for a mesh, and initialize it to appropriate default
     * values.
     */
    ...
    /**
     * Set the list of parameter values. val is an array containing the parameter value at every
     * vertex of every face. Specifically, val[i][j] is the value at the j'th vertex of the i'th
     * face.
     */
    ...
    /**
     * Get the value of the parameter at a particular point within the interior of a face. This
     * method assumes the face is triangular (which is always the case for a parameter of a
     * RenderingMesh).
     */
    @Override
    ...
    public ParameterValue duplicate() {
        ...
        copy.faceStartIndex = faceStartIndex.clone();
        return copy;
    }
