...
/**
 * UVMappingViewer appears in the UVMappingWindow, and is used for editing the UV texture
 * coordinates at each vertex of a mesh.
 */
public class UVMappingViewer extends MeshViewer {
    ...
    /**
     * Get a list of which vertices are selected. The array length is equal to the total number of
     * vertices in the object being edited, not just the ones currently displayed in this viewer.
     */
    ...
    /**
     * When the user presses the mouse, forward events to the current tool as appropriate. If this
     * is a vertex based tool, allow them to select or deselect vertices.
     */
    @Override
    ...
    private class UVEditController implements MeshEditController {
        ...
        /**
         * Set an array of flags specifying which parts of the object are selected. Depending on the
         * selection mode and type of object, this may correspond to vertices, faces, edges, etc.
         */
        @Override
