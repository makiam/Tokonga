...
/**
 * LayeredTexture represents a texture which is composed of other textures layered on top of each
 * other. This class serves mainly as a placeholder - most of the real work is done by
 * LayeredMapping.
 */
