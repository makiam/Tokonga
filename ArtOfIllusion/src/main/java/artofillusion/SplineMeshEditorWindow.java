...
public class SplineMeshEditorWindow extends MeshEditorWindow implements EditingWindow {
     ...
     * the current selection mode, these flags may correspond to vertices or curves.
     */
    @Override
    ...
    /**
     * Add an extra texture parameter to the mesh which will be used for keeping track of joint
     * weights.
     */
    ...
    /**
     * Remove the extra texture parameter from the mesh which was used for keeping track of joint
     * weights.
     */
