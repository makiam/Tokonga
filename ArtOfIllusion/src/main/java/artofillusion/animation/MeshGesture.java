...
public abstract class MeshGesture implements Gesture {
     ...
     * averaged about this pose. This affects only the skeleton, not the vertex positions or texture
     * parameters.
     *
     ...
     * texture parameters, not the skeleton, and all vertex positions are based on the offsets from
     * the joints they are bound to.
     *
     * @param average the Gesture to modify to be an average of other Gestures
     * @param p the list of Gestures to average
     * @param weight the weights for the different Gestures
