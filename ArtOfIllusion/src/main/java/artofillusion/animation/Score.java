...
public class Score extends BorderContainer implements EditingWindow, PopupMenuManager {
    ...
    private void createPopupMenu() {
        ...
        popupMenu.add(popupMenuItem[3] = Translate.menuItem("enableTracks", window, "enableTracksAction", null));
        popupMenu.add(popupMenuItem[4] = Translate.menuItem("disableTracks", window, "disableTracksAction", null));
    }
    ...
    /**
     * Layout the display in the right side of the Score, based on the current view mode and
     * selected tracks.
     */
    ...
    /**
     * This is called whenever there is a change to which tracks are selected. It updates the list
    ...
    /**
     * This is called whenever a track is modified. It causes all graphs to be properly updated and,
     * optionally, updates the Scene to reflect any changes to selected keyframes.
     */
    ...
    /**
     * This is called when a time marker has been moved. If this is an intermediate position in the
     * middle of a drag, then intermediate will be true.
     */
...
//    theAxis.setSize(theAxis.getSize().width, theAxis.getPreferredSize().height); // Workaround for layout manager bug.
    ...
    /**
     * EditingWindow methods. Most of these either do nothing, or simply call through to the
     * corresponding methods of the LayoutWindow the Score is in.
     */
    @Override
