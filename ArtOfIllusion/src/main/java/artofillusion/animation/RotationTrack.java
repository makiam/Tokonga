...
public class RotationTrack extends Track {
    ...
    /**
     * Get the object reference for the parent coordinate system. The return value is undefined if
     * getCoordinateSystem() does not return OBJECT.
     */
    ...
    /**
     * Set the object reference for the parent coordinate system. This causes the coordinate system
     * to be set to OBJECT.
     */
    ...
    /**
     * Set the ID of the joint this track applies to. Specify -1 if it should apply to the object
     * origin.
     */
