...
/**
 * This interface represents an object which can be used to represent a predefined gesture for an
 * Actor.
 */
public interface Gesture extends Keyframe {

    /**
     * Return a new gesture which is the weighted average of an arbitrary list of gestures. The
     * gestures are averaged around this gesture. That is, the returned gesture is represented
     * symbolically as
     * <p>
