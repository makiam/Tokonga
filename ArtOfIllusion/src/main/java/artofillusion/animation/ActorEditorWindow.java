...
public class ActorEditorWindow extends BDialog {
    ...
    /**
     * Display a window for editing a pose of an Actor. If key is null, the Actor's current pose
     * will be edited. Otherwise, the specified keyframe will be edited.
     */
     ...
     */
    private void doSave() {
        String name = new BStandardDialog("", Translate.text("savePoseAsGesture"), BStandardDialog.PLAIN).showInputDialog(this, null, "New Gesture");
        if (name == null) {
            return;
        }
    ...
    private void doExtract() {
        String name = new BStandardDialog("", Translate.text("savePoseAsObject"), BStandardDialog.PLAIN).showInputDialog(this, null, "Extracted Pose");
        if (name == null) {
            return;
        }
    ...
    private void doRename() {
        ...
        String name = new BStandardDialog("", Translate.text("enterNewNameForGesture"), BStandardDialog.PLAIN).showInputDialog(this, null, theObject.gestureName[which]);
        if (name == null) {
            return;
        }
    ...
    private void doDuplicate() {
        int which = gestureList.getSelectedIndex();
        String name = new BStandardDialog("", Translate.text("enterNameForNewGesture"), BStandardDialog.PLAIN).showInputDialog(this, null, "Copy of " + theObject.gestureName[which]);
        if (name == null) {
            return;
        }
