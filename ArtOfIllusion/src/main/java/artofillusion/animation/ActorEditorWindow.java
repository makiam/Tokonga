...
public class ActorEditorWindow extends BDialog {
    ...
    private final Actor theObject;
    private final Actor oldObject;
    private final ObjectInfo objInfo;
    private final EditingWindow theWindow;
    private final BList gestureList;
    private final BTable currentPoseTable;
    private final CurrentPoseTableModel tableModel;
    private final BButton addButton;
    private final BButton removeButton;
    private final BButton saveButton;
    private final BButton editButton;
    private final BButton renameButton;
    private final BButton copyButton;
    private final BButton deleteButton;
    private final ActionProcessor processor;
    private final ActorKeyframe currentPose;
    private final ActorKeyframe key;
    private final ObjectPreviewCanvas preview;
    private final Runnable onClose;
    private final boolean canModifyGestures;
