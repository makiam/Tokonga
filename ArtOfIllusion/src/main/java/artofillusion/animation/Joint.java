...
public class Joint {
    ...
    /**
     * Get the matrix which transforms direction vectors from the parent joint's coordinate system
     * to this one.
     */
    ...
    /**
     * Get the matrix which transforms direction vectors from this joint's coordinate system to its
     * parent's.
     */
    ...
    /**
     * This is an inner class for storing information about the properties of a particular degree of
     * freedom.
     */
    public class DOF {
        ...
        /**
         * Given a force applied to the degree of freedom, return a new force which is scaled based
         * on the stiffness, the direction of the force, and whether it is inside its comfort range.
         */
        ...
        /**
         * Given a force applied to the degree of freedom, return a scale factor based on the
         * stiffness, the direction of the force, and whether it is inside its comfort range.
         */
        ...
        /**
         * Given a force applied to the degree of freedom, return a new force which is clipped so as
         * not to move it beyond the allowed range.
         */
