...
public class PoseTrack extends Track {
    ...
    /**
     * Set the list of graphable values for this track. Usually, this will only be called by its
     * parent object.
     *
     * @param names the names of the graphable values
     * @param defaults the default values of the graphable values
     * @param ranges specifies the allowed range of each graphable values. elements [n][0] and
     * [n][1] are the minimum and maximum allowed values, respectively, for the nth graphable value.
     */
    ...
    /**
     * Set the list of subtracks (other than the weight track) for this track. Usually, this will
     * only be called by its parent object.
     */
