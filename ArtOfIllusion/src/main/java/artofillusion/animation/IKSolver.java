...
public class IKSolver {
     ...
     * @param locked an array of size (# joints in skeleton) specifying which ones are locked in
     * place
    ...
    /**
     * Find any degrees of freedom which are absolutely forbidden to change, since they would
     * necessarily cause locked joints to move.
     */
     ...
     *
     * @param target an array of size (# joints in skeleton) specifying the target of each one (or
     * null)
     ...
     * @return true if a solution was reached, false if it had not yet converged after maxSteps
     * iterations
     */
