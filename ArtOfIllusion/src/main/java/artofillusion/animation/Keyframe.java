...
/**
 * This interface represents any object which can be used to represent a keyframe on an animation
 * track.
 * <p>
 * Every Keyframe class should also provide a constructor of the following form, which reconstructs
 * the keyframe from its serialized representation.
 *
 * public KeyframeClass(DataInputStream in, Object parent) throws IOException,
