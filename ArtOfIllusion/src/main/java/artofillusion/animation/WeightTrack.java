...
public class WeightTrack extends Track<WeightTrack> {
    ...
    public void editKeyframe(LayoutWindow win, int which) {
        ...
        s2Slider.setEnabled(sameBox.getState());
        ComponentsDialog dlg = new ComponentsDialog(win, Translate.text("editKeyframe"), new Widget[]{weightSlider, timeField, sameBox, new BLabel(Translate.text("Smoothness") + ':'), s1Slider, s2Slider},
