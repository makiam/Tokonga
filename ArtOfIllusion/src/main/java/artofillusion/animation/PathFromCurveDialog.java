...
public class PathFromCurveDialog extends BDialog {
    ...
    private final ValueField endTimeField;
    private final ValueField startSpeedField;
    private final ValueField endSpeedField;
    private final ValueField accelField;
