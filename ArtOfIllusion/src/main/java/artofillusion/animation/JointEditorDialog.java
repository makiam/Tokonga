...
public class JointEditorDialog extends BDialog {
    ...
    private final MeshEditorWindow window;
    private final Mesh theMesh;
    private final Object3D oldMesh;
    private final Joint joint;
    private final BTextField nameField;
    private final DOFPanel ang1Panel;
    private final DOFPanel ang2Panel;
    private final DOFPanel twistPanel;
    private final DOFPanel lengthPanel;
    ...
    private class DOFPanel extends ColumnContainer {
        ...
        public final ValueField valField;
        public final ValueField minField;
        public final ValueField maxField;
        public final ValueField minComfortField;
        public final ValueField maxComfortField;
        public final ValueSlider stiffnessSlider;
        public final BCheckBox fixedBox;
    ...
    private class DOFGraph extends CustomWidget {
        ...
        private final Color restColor1 = new Color(223, 31, 63, 127);
        private final Color restColor2 = new Color(223, 31, 63, 255);
        private final Color comfColor1 = new Color(255, 199, 63, 127);
        private final Color comfColor2 = new Color(255, 199, 63, 255);
        private final Color valuColor1 = new Color(31, 99, 159, 255);
        private final Color valuColor2 = new Color(47, 63, 127);
        private final Color valuColor3 = new Color(175, 175, 175);
        private final Color dialActive = Color.white;
        private final Color dialIdle = new Color(223, 223, 223);
        private final Color dialMark = Color.gray;

        private final Point centerPoint;
        private final BufferedImage image;
        private final Graphics2D g2;
        private final AffineTransform atr_init;
        private final AffineTransform atr_draw;
        private final Ellipse2D.Double dial;
        private final Ellipse2D.Double trace;
        private final Shape[] marker = new Shape[24];
