...
public class Actor extends ObjectWrapper {
    ...
    /**
     * Return the index of the gesture with a particular ID, or -1 if there is no gesture with that
     * ID.
     */
     ...
     * of gestures that most nearly reproduce that skeleton shape, and then adjusts all of the
     * vertex positions based on the gestures.
     */
    ...
    /**
     * This is a utility routine. It takes an Object3D as its argument. If the object is an Actor,
     * it is simply returned. If the argument is an ObjectWrapper which contains an Actor, the inner
     * Actor is returned. Otherwise, it returns null.
     */
    ...
    /**
     * Inner class representing a pose for an Actor. It consists of a list of gestures, and a weight
     * for each one.
     */
