...
/**
 * This class implements the dialog box which is used for the "Object Layout" and "Transform Object"
 * commands. It allows the user enter values for the position, orientation, and size of an object.
 * The initial values are passed to the constructor in values[]. If this argument is omitted, all of
 * the fields will initially be blank. If transformLabels is true, the rows will be labelled "Move",
 * "Rotate", and "Scale". If it is false, they will be labelled "Position", "Orientation", and
 * "Size".
 */
public class TransformDialog extends BDialog {
    ...
    /**
     * Determine whether rotations should be around the center of each object, or the center of the
     * entire selection.
     */
