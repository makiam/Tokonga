...
public class TriMeshBeveler {
    ...
    private final TriangleMesh origMesh;
    ...
    private TriangleMesh bevelFacesAsGroup(double height, double width) {
        ...
        for (int i = 0; i < v.length; i++) {
            if (allSelected[i]) {
                ...
                for (int j = 0; j < numVertFaces[i]; j++) {
                ...
                for (int j = 1; j < numVertFaces[i]; j++) {
                    for (int k = 0; k < j; k++) {
                        f1 = f[vertFace[i][j]];
                        f2 = f[vertFace[i][k]];
                ...
                for (int j = 0; j < numVertFaces[i]; j++) {
                    for (int k = 0; k < numVertFaces[i]; k++) {
