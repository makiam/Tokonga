...
public interface CanvasDrawer {
     ...
     */
    void setTemplateImage(Image im);
     ...
     */
    void drawBoxes(java.util.List<Rectangle> box, Color color);

    /**
     * Render a filled box at a specified depth in the rendered image.
     */
    void renderBox(int x, int y, int width, int height, double depth, Color color);

    /**
     * Render a set of filled boxes at specified depths in the rendered image.
     */
    void renderBoxes(java.util.List<Rectangle> box, java.util.List<Double> depth, Color color);
     ...
     */
    void renderLine(Vec3 p1, Vec3 p2, Camera cam, Color color);
     ...
     * @param color the line color
     */
    void renderLine(Vec2 p1, double zf1, Vec2 p2, double zf2, Camera cam, Color color);

    /**
     * Render a wireframe object.
     */
    void renderWireframe(WireframeMesh mesh, Camera cam, Color color);
     ...
     */
    void drawString(String text, int x, int y, Color color);
     ...
     */
    void renderImage(Image image, Vec3 p1, Vec3 p2, Vec3 p3, Vec3 p4, Camera camera);
