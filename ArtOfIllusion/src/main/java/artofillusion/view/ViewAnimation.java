...
/**
 * ViewAnimation is the animation engine, that is used to produce e.g., smooth switching between
...
public class ViewAnimation {
    ...
    final EditingWindow window;
    boolean animate = ArtOfIllusion.getPreferences().getUseViewAnimations();
    final double maxDuration = ArtOfIllusion.getPreferences().getMaxAnimationDuration(); // Seconds
    ...
    final double rotSlope = 1.5;
    final double moveSlope = 1.5;
  ...
  int endOrientation, endNavigation;
     ...
     */
    private final Timer timer = new Timer(timerInterval, new ActionListener() {
        @Override
