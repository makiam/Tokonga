...
/**
 * This interface defines an object which selects colors for vertices. Objects implementing this
 * interface are passed to a ViewerCanvas to tell it how to render a surface interactively.
 */
public interface VertexShader {
    ...
    /**
     * Get the texture properties of the surface. This should only be called if isUniformTexture()
     * returns true.
     *
