...
public class ViewerOrientationControl implements ViewerControl {
    ...
    public static class OrientationChoice extends BComboBox {
        ...
        /**
         * This is needed because several view cameras may have the same name. Using just Strings in
         * the ComboBox results selecting always the first occurrence of a name.
         */
