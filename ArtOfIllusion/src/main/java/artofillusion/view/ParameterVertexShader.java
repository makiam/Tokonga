...
public class ParameterVertexShader implements VertexShader {
    ...
    private final RGBColor lowColor;
    private final RGBColor highColor;
    private final double minValue;
    private final double maxValue;
    private final double rprimehigh;
    private final double gprimehigh;
    private final double bprimehigh;
    private final double rprimelow;
    private final double gprimelow;
    private final double bprimelow;
    private final RenderingMesh mesh;
