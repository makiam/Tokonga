...
public class GLCanvasDrawer implements CanvasDrawer {
    ...
    private final WeakHashMap<Image, GLTexture> textureMap = new WeakHashMap<>();
    private final ReferenceQueue textureCleanupQueue = new ReferenceQueue();
    private final HashSet<TextureReference> textureReferences = new HashSet<>();

    private static final float COLOR_SCALE = 1.0f / 255.0f;
    private static final HashMap<String, SoftReference<GLImage>> textImageMap = new HashMap<>();
    private static final WeakHashMap<Image, SoftReference<GLImage>> imageMap = new WeakHashMap<>();
