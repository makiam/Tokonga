 ...
 */
/**
 * A SafeFileOutputStream modifies a file safely, in a way that permits rollback of the changes.
 */
import java.io.File;
...
public class SafeFileOutputStream extends FilterOutputStream {
     ...
     * abort the stream
     *
     * closes the underlying stream, frees all resources, and removes any temporary files.
     */
    public void abort()
            throws IOException {
        if (out != null) {
