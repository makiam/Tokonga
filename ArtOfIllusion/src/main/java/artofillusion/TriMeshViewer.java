...
/**
 * The TriMeshViewer class is a component which displays a TriangleMesh object and allow the user to
 * edit it.
 */
public class TriMeshViewer extends MeshViewer {
    ...
    /**
     * The TriMeshEditorWindow may hide parts of the control mesh. Get how it
     * affects the preview mesh.
     */
    @Override
