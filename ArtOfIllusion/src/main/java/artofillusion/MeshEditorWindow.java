...
/**
 * The MeshEditorWindow class represents the window for editing Mesh objects. This is an abstract
 * class, with subclasses for various types of objects.
 */
public abstract class MeshEditorWindow extends ObjectEditorWindow implements MeshEditController, EditingWindow {
    ...
    /**
     * Get an array of flags specifying which parts of the mesh are selected. Depending on the
     * selection mode, this may correspond to vertices, faces, edges, etc.
     */
    @Override
    public abstract boolean[] getSelection();

    /**
     * Set an array of flags specifying which parts of the mesh are selected. Depending on the
     * selection mode, this may correspond to vertices, faces, edges, etc.
     */
    @Override
    ...
    /**
     * Get the distance of each vertex from a selected vertex. This is 0 for a selected vertex, 1
     * for a vertex adjacent to a selected one, etc., up to a specified maximum distance. For
     * vertices more than the maximum distance for a selected one, it is -1.
     */
    @Override
     ...
     * the editor. By default this returns null. Subclasses which use an extra parameter to keep
     * track of face indices should override it.
     */
     ...
     * By default this returns null. Subclasses which use an extra parameter to keep track of joint
     * weights should override it.
     */
