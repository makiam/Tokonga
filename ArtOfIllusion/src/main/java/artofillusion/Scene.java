...
public class Scene {
     ...
     * a subset of the animation tracks on the modified objects themselves to reflect their
     * dependencies on other parts of the scene.
     */
    ...
    /**
     * Get the Scene's environment mapping mode. This will be either ENVIRON_SOLID, ENVIRON_DIFFUSE,
     * or ENVIRON_EMISSIVE.
     */
    ...
    /**
     * Set the Scene's environment mapping mode. This should be either ENVIRON_SOLID,
     * ENVIRON_DIFFUSE, or ENVIRON_EMISSIVE.
     */
    ...
    /**
     * Get the TextureMapping being used to map the environment map texture to the environment
     * sphere.
     */
    ...
    /**
     * Set the TextureMapping to use for mapping the environment map texture to the environment
     * sphere.
     */
    ...
    /**
     * Add a new object to the scene. If undo is not null, appropriate commands will be added to it
    ...
    /**
     * Add a new object to the scene in the specified position. If undo is not null, appropriate
    ...
    /**
     * Delete an object from the scene. If undo is not null, appropriate commands will be added to
    ...
    /**
     * This method should be called after a Material has been edited. It notifies any objects using
    ...
    /**
     * This method should be called after a Texture has been edited. It notifies any objects using
    ...
    /**
     * Store a piece of metadata in this scene. This may be an arbitrary object which you want to
     * store as part of the scene. When the scene is saved to disk, metadata objects are stored
     * using the java.beans.XMLEncoder class. This means that if the object is not a bean, you must
     * register a PersistenceDelegate for it before calling this method. Otherwise, it will fail to
     * be saved.
     *
    ...
    /**
     * Replace every instance of one object in the scene with another one. If undo is not null,
     * commands will be added to it to undo this operation.
     */
    ...
    /**
     * Get the object with the specified name, or null if there is none. If more than one object has
   ...
   *
    ...
    /**
     * Get the texture with the specified name, or null if there is none. If more than one texture
    ...
    /**
     * Get the material with the specified name, or null if there is none. If more than one material
     * has the same name, this will return the first one.
     */
    ...
    /**
     * Get the indices of all objects which are either selected, or are children of selected
     * objects.
     *
    ...
    /**
     * Return true if any errors occurred while loading the scene. The scene is still valid and
     * usable, but some objects in it were not loaded correctly.
     */
    ...
    /**
     * The following constructor is used for reading files. If fullScene is false, only the Textures
    ...
    /**
     * The following constructor is used for reading from arbitrary input streams. If fullScene is
     * false, only the Textures and Materials are read.
     */
