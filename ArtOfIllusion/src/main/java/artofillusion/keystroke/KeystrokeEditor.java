...
/**
 * This class presents a user interface for editing a single KeystrokeRecord. To use it, invoke the
 * static editKeystroke() method.
 */
public class KeystrokeEditor extends BDialog {
     ...
     * @return a new KeystrokeRecord representing the edited keystroke, or null if the user clicked
     * Cancel.
     */
