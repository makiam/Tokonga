...
public class CameraFilterDialog extends BDialog implements RenderListener {
    ...
    /**
     * The renderer may call this method periodically during rendering, to notify the listener that
     * more of the image is complete.
     */
    @Override
    ...
    /**
     * This is the panel containing the list of filters and the parameters for each one. It is a
     * separate class so it can be reused in the rendering window.
     */
