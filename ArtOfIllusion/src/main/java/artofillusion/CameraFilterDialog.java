...
public class CameraFilterDialog extends BDialog implements RenderListener {
    ...
    private final SceneCamera theCamera;
    private final Scene theScene;
    private final CoordinateSystem cameraCoords;
    private final ImageFilter[] oldFilters;
    ...
    private static final HashMap<Renderer, Map<String, Object>> rendererConfiguration = new HashMap<>();
    ...
    public static class FiltersPanel extends FormContainer {
        ...
        private final BScrollPane editorPane;
        private final BList allFiltersList;
        private final BList cameraFiltersList;
