 ...
 * RGBE format, as described in "Graphics Gems IV", edited by James Arvo, Academic Press, 1994.
 */
public class HDRImage extends ImageMap {
    ...
    /**
     * Given the r, g, b, and e arrays for an image, this method builds the full set of mipmaps for
     * it.
     */
    ...
    /**
     * Get the value of a single component at a particular location in the image. The components
     * are:
     *
     ...
     * no larger but may be smaller than PREVIEW_WIDTH by PREVIEW_HEIGHT.
     */
    @Override
