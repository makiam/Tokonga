 ...
 * It provides a Widget with which the user can edit it. They can choose either a single value, or a
 * component of an ImageMap which can be multiplied by a user specified value.
 */
public class ImageOrValue {
    ...
    /**
     * Given a texture coordinate (x and y each between 0 and 1), return the average value of a
