...
public class MIPMappedImage extends ImageMap {
    ...
    /**
     * This method constructs a set of byte arrays containing the image data for each component of
     * the Image object.
     */
    ...
    /**
     * This method determines the number of independent color components in the image. This will be
     * either 1 (monochrome), 3 (RGB), or 4 (ARGB).
     */
    ...
    /**
     * Get the value of a single component at a particular location in the image. The value is
     * represented as a float between 0.0 and 1.0. The components are:
     *
     * 0: Red 1: Green 2: Blue 3: Alpha
     *
     * The location is specified by x and y, which must lie between 0 and 1. The value is averaged
     * over a region of width (xsize, ysize). wrapx and wrapy specify whether, for purposes of
     * interpolation, the image should be treated as wrapping around so that opposite edges touch
     * each other.
     */
    @Override
    ...
    /**
     * This method is called by getComponent. It determines the value at the point (x, y) of the
     * particular mipmap.
     */
    ...
    /**
     * Get the color at a particular location. The location is specified by x and y, which must lie
     * between 0 and 1. The color is averaged over a region of width (xsize, ysize). wrapx and wrapy
     * specify whether, for purposes of interpolation, the image should be treated as wrapping
     * around so that opposite edges touch each other.
     */
    @Override
    ...
    /**
     * This method is called by getColor. It determines the color at the point (x, y) of the
     * particular mipmap.
     */
     ...
     * specified by x and y, which must lie between 0 and 1. The value is averaged over a region of
     * width (xsize, ysize) before the gradient is calculated. wrapx and wrapy specify whether, for
     * purposes of interpolation, the image should be treated as wrapping around so that opposite
    ...
    /**
     * This method is called by getGradient. It determines the gradient at the point (x, y) of the
     * particular mipmap.
     */
    ...
    /**
     * Get a scaled down copy of the image, to use for previews. The dimensions of the Image will be
     * no larger but may be smaller than PREVIEW_SIZE_DEFAULT.
     */
    @Override
    ...
    /**
     * Get a scaled down copy of the image, to use for previews. The dimensions of the Image will be
     * no larger but may be smaller than size.
     */
    @Override
    ...
    /**
     * Reconstruct an image from its serialized representation. This constructor is provided only
     * for compatibility with versions of AoI prior to 1.4, which did not write image version
