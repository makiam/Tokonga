...
public class ImageSaver {
     ...
     * displays a dialog in which the user can select the name, location, and format. The
     * saveImage() method can then be used to save individual frames of the animation. Use
     * clickedOk() to determine whether the user clicked the OK or Cancel button.
     */
     ...
     * displays a dialog in which the user can select the name, location, and format. The
     * saveImage() method can then be used to save individual frames of the animation, and
     * lastMovieImage() should be called once all frames have been saved. Use clickedOk() to
     * determine whether the user clicked the OK or Cancel button.
     *
     ...
     *
     * @param parent the parent window
     * @param startFrameNumber the default number for the first frame of an animation, or
     * Integer.MIN_VALUE for a single image
     */
    ...
    /**
     * Save an image to disk in the specified format. Returns true if the image was successfully
     * saved, false if an error occurred. For JPEG, quality should be between 0 and 100. For other
    ...
    /**
     * Determine whether this image is partially transparent, and if so, create a new image in which
     * the color components are premultiplied by the transparency.
     */
    ...
    /**
     * Get a BufferedImage containing the image from a ComplexImage. This is necessary for using the
     * ImageIO classes, which only work on BufferedImages.
     */
