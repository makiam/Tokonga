...
public class SVGImage extends ImageMap {
    ...
    /**
     * Get a scaled copy of the image, to use for previews. The dimensions of the Image will be no
     * larger but may be smaller than PREVIEW_DEFAULT.
     */
    @Override
    ...
    /**
     * Get a scaled copy of the image, to use for previews. The dimensions of the Image will be no
     * larger but may be smaller than size.
     */
    @Override
