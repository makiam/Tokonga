...
/**
 * This class stores an image, with optional additional floating point values for each pixel. It is
 * intended to be extensible, so that as features are added to the renderers, the amount of
 * information available for each pixel can grow.
 */
public class ComplexImage {
    ...
    /**
     * Set the floating point values of a particular component for each pixel. The length of the
     * value array should be equal to the number of pixels in the image, and the values should be
     * ordered by rows.
     */
    ...
    /**
     * Create a duplicate of this object. The new ComplexImage will refer to the same Image object
     * as the other, but all other fields will be cloned.
     */
    ...
    /**
     * Rebuild the Image from the floating point components. This should be called after the
