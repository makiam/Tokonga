...
/**
 * ImageMap represents an image which can be used for texturing an object. The number of components
 * can range from one (monochrome) to four (ARGB). It also provides a scaled down Image object which
 * can be used to preview the image.
 * <p>
...
public abstract class ImageMap {
     ...
     * <p>
     *
      If a preview image has been created already thst image will be returned<br>. If there is no
     * existing perview image a default size preview image will b returned. This Image will be no
     * larger (but may be smaller) than PREVIEW_WIDTH by PREVIEW_HEIGHT.
     */
    public abstract Image getPreview();

    /**
     * Get a scaled down copy of the image, to use for previews. This Image will be no larger (but
     * may be smaller) than 'size' by 'size'.
     */
    ...
    /**
     * Override this to get the image type string.
     * <p>
     *
