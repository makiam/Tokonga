...
public class ImagesDialog extends BDialog {
    ...
    /**
     * Pressing Return and Escape are equivalent to clicking OK and Cancel. Arrow keys can be used
     * to select.
     */
    ...
    /**
     * ImagesCanvas is an inner class which displays the loaded images and allows the user to select
