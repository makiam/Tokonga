...
public class SceneViewer extends ViewerCanvas {
    ...
    /**
     * ViewAnimation calls this when the animation is finished, so the menu will be up to date.
     */
    @Override
     ...
     * is an object based tool, allow them to select or deselect objects.
     */
    @Override
    ...
    /**
     * Check if an object can be selected in perspective mode. An object, whose origin is on the
     * "camera plane" or behid it, should not be selected, when the view is set to perspective.
     */
