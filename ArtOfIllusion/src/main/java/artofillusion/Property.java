...
/**
 * This class defines an arbitrary property of an object. It specifies the property name, the type
 * of property (numeric, text, boolean, etc.), and the set of allowed values.
 */
public class Property {
    ...
    /**
     * Get the list of allowed values. The return value is undefined and meaningless if this
     * property has a type other than ENUMERATION.
     */
