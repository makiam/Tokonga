...
public abstract class Material3D extends Material {
    ...
    /**
     * Get the properties at point (x, y, z) at time t. More precisely, the properties returned
     * should represent an average over a region of width (xsize, ysize, zsize), which is centered
     * at (x, y, z).
     */
