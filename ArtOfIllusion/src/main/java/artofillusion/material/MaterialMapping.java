...
public abstract class MaterialMapping {
    ...
    /**
     * Every subclass of MaterialMapping must define a constructor which takes a Material and an
     ...
     * <p>
     * public MappingSubclass(DataInputStream in, Object3D theObject, Material theMaterial) throws
    ...
    /**
     * Given a point inside the object for which this mapping is being used, find the corresponding
     * material properties. The properties should be averaged over a region of width size.
     */
    ...
    /**
     * Create a new MaterialMapping which is identical to this one, but for a different object and
     * Material.
     */
