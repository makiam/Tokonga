...
/**
 * A Material represents a description of the bulk physical properties of an object: internal color
 * and transparency, index of refraction, etc. This is distinct from the surface properties, which
 * are described by a Texture object.
 */
public abstract class Material {
    ...
    /**
     * Get the name of this type of material. Subclasses should override this method to return an
     * appropriate name.
     */
    ...
    /**
     * Return true if this Material makes use of the specified ImageMap. Materials which use
     * ImageMaps should override this method.
     */
    ...
    /**
     * Allow the user to interactively edit the naterial. parent is a WindowWidget which can be used
     * as a parent for Dialogs, and sc is the Scene which this Material is part of. Subclasses
     * should override this to implement editing.
     */
