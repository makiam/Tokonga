...
public class ProceduralMaterial3D extends Material3D implements ProcedureOwner {
    ...
    /**
     * Add a module to the procedure and link it to a particular output. This is used when reading
     * old files that need to have modules added to maintain backward compatibility.
     */
