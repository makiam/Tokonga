...
/**
 * This is the main class for Art of Illusion. All of its methods and variables are static, so no
 * instance of this class ever gets created. It starts up the application, and maintains global
 * variables.
 */
public class ArtOfIllusion {
    ...
    /**
     * Get a class specified by name. This checks both the system classes, and all plugins. It also
     * accounts for classes which changed packages in version 1.3.
     */
    ...
    /**
     * Save a scene to a file. This method returns true if the scene is successfully saved, false if
     * an error occurs.
     */
    ...
    /**
     * Prompt the user to select a scene file, then open a new window containing it. The BFrame is
    ...
    /**
     * Copy a list of objects to the clipboard, so they can be pasted into either the same scene or
     * a different one.
     */
