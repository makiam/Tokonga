...
public class Module {
    ...
    /**
     * Calculate the size on the screen of this module. The default implementation makes it large
     * enough to display the name of the module.
     */
    ...
    /**
     * Layout the module's onscreen representation. This should be called any time the module is
     * moved or resized.
     */
    public void layout() {
        calcSize();
    ...
    /**
     * This should display a user interface for editing the module, and return true if the module is
     * changed. The default implementation does nothing.
     *
     ...
     * will cause all edits to be reverted automatically. The module does not need to do that
     * itself.
     */
    ...
    /**
     * This method initializes the module in preparation for evaluating the procedure at a new
     * point. The default implementation does nothing. Subclasses whose output depends on the point
    ...
    /**
     * Get the average value of the specified output port. If the specified output port does not
     * have a value type of NUMBER, the result is undefined. Blur specifies the amount of smoothing
     * to use. Subclasses which can return values should override this method.
     */
    ...
    /**
     * Get the uncertainty in the value of the specified output port. If the specified output port
     * does not have a value type of NUMBER, the result is undefined. Blur specifies the amount of
     * smoothing to use. Subclasses which can return values should override this method.
     */
    ...
    /**
     * Get the gradient of the value of the specified output port. If the specified output port does
     * not have a value type of NUMBER, the result is undefined. Blur specifies the amount of
     * smoothing to use. Subclasses which can return values should override this method.
     */
    ...
    /**
     * Get the color of the specified output port. If the specified output port does not have a
     * value type of COLOR, the result is undefined. Blur specifies the amount of smoothing to use.
     * Subclasses which can return colors should override this method.
     */
    public void getColor(int which, RGBColor color, double blur) {
    }

    /**
     * Create a duplicate of this module. Subclasses with adjustable parameters should override
     * this.
     */
    ...
    /**
     * Write out the module's parameters to an output stream. Subclasses with editable parameters
     * should override this method.
     */
    ...
    /**
     * Read in the module's parameters from an input stream. Subclasses with editable parameters
     * should override this method.
     */
