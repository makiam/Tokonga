 ...
 */
@Slf4j
public class ProcedureEditor extends BFrame {
    ...
    private final ProcedureEditorPane view;
    ...
    public ProcedureEditor(Procedure proc, ProcedureOwner owner, Scene scene) {
        super(owner.getWindowTitle() + " : " + owner.getName());
        this.proc = proc;
        this.view = new ProcedureEditorPane(proc);
        this.owner = owner;
        this.scene = scene;
...
//        addEventLink(MouseDraggedEvent.class, this, "mouseDragged");
        ...
        try(DataOutputStream out = new DataOutputStream(cancelBuffer)) {
        ...
        content.add(new BSplitPane(BSplitPane.HORIZONTAL, new ModuleMenu(this), new ProcedureEditorPane(this.proc)), BorderContainer.CENTER);
