...
/**
 * This is the editor for editing procedures. It subclasses CustomWidget, but you should never add
 * it to any Container. Instead, it will automatically create a BFrame and add itself to that.
 */
