...
/**
 * This is the menu that appears in the procedure editor window. It displays modules organized into
 * categories, and allows the user to add them to their procedure.
 */
