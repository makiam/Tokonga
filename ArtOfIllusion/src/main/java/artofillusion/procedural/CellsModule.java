...
/**
 * This is a Module which generates a pattern based on Steven Worley's cellular texture basis
 * function.
 */
public class CellsModule extends ProceduralModule {
    ...
    /**
     * Get the metric to use for the cells function. This is one of the constants defined in the
     * Cells class.
     */
