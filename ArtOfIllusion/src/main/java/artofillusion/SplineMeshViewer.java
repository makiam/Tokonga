...
/**
 * The SplineMeshViewer class is a component which displays a SplineMesh object and allow the user
 * to edit it.
 */
public class SplineMeshViewer extends MeshViewer {
    ...
    /**
     * Determine which vertex or curve (depending on the current selection mode) the mouse was
    ...
    /**
     * Given a click position and the endpoints of a line, this method determines whether the click
     * was on top of the line. If so, it returns the z coordinate of the line at the point where it
     * was clicked. Otherwise, it returns Double.MAX_VALUE.
     */
