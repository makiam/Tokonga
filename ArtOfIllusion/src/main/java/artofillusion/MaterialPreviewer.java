...
/**
 * MaterialPreviewer is a component used for renderering previews of Materials. It displays a scene
 * consisting of a Sphere with the desired Material applied to it, a ground plane, and a single
 * light. Optionally, an Object3D may be specified which will then be used instead of a Sphere.
 */
public class MaterialPreviewer extends CustomWidget implements RenderListener {
    ...
    /**
     * Create a MaterialPreviewer to display a Texture and/or Material mapped to a sphere. Either
     * tex or mat may be null.
     */
    ...
    /**
     * Create a MaterialPreviewer to display the specified object, with its current texture and
     * material.
     */
