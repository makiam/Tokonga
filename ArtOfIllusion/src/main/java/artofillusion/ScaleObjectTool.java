...
public class ScaleObjectTool extends EditingTool {
    ...
    /**
     * Given a bounding box, the definitions of its horizontal and vertical axes, and the index of a
     * handle, return the corresponding point on the border of the box.
     */
