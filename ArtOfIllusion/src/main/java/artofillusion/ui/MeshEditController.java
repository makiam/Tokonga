...
public interface MeshEditController {
    ...
    /**
     * Set the selection mode. The allowed values are POINT_MODE, EDGE_MODE, and FACE_MODE, although
     * some modes may not be permitted for some controllers.
     */
    public void setSelectionMode(int mode);

    /**
     * Get an array of flags specifying which parts of the object are selected. Depending on the
    ...
    /**
     * Get the distance of each vertex from the selected part of the object. This is 0 for a
     * selected vertex, 1 for a vertex adjacent to a selected one, etc., up to a specified maximum
