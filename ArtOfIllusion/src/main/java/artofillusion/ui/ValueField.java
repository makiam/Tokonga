 ...
 * for the value, for example, that it must be positive. If an illegal value is entered into the
 * text field, the text turns red to indicate this.
 */
public class ValueField extends BTextField {
    ...
    /**
     * Set a ValueChecker to be used for determining whether the value is valid. The value must
     * satisfy both the ValueChecker *and* any other constraints to be considered valid.
     */
    ...
    /**
     * Set whether this field should send out all ValueChangedEvents, or only those which result in
     * valid entries (the default).
     */
