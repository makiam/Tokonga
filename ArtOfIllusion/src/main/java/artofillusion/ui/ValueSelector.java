...
public class ValueSelector extends RowContainer {
     ...
     * @param min the minimum legal value. Specify Double.NEGATIVE_INFINITY if the range is not
     * bounded from below.
     * @param max the maximum legal value. Specify Double.POSITIVE_INFINITY if the range is not
     * bounded from above.
