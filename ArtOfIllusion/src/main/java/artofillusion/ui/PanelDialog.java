...
/**
 * A PanelDialog is a modal dialog containing a line of text at the top, and a single Widget
 * (usually a container with other Widgets). At the bottom are two buttons labeled OK and Cancel.
 */
