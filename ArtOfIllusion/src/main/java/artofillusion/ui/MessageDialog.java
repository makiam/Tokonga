...
/**
 * A MessageDialog is a modal dialog containing one or more lines of text, and one or more buttons
 * for the user to select from. Clicking any of the buttons dismisses the dialog.
 * <p>
 * This class is provided mainly for backward compatibility. In most cases, it is better to use a
 * BStandardDialog, since that will have the correct platform-specific appearance. This class does
 * have two advantages over BStandardDialog, however: it can display an arbitrary number of custom
 * buttons, and it automatically breaks text into multiple lines.
 */
