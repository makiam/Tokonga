...
public class ColorChooser extends BDialog {
    ...
    private final ValueSlider slider2;
    private final ValueSlider slider3;
    private final BLabel label1;
    private final BLabel label2;
    private final BLabel label3;
    private final Widget newColorPatch;
    private final BComboBox modeC;
    private final BComboBox rangeC;
    private boolean ok;
    ...
    public ColorChooser(Widget parent, String title, RGBColor c, boolean show) {
        ...
        ActionListener action = e -> cancelImpl();
