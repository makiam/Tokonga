 ...
 /* Add another element as a child of this one. */
    ...
    public void addChild(TreeElement el, int position) {
        ...
        if (el.getObject() instanceof ObjectInfo) {
            if (tree.undo != null) {
                tree.undo.addCommandAtBeginning(UndoRecord.REMOVE_FROM_GROUP, new Object[]{info, el.getObject()});
            }
    ...
    public void removeChild(Object object) {
        ...
        if (tree.undo != null) {
            tree.undo.addCommandAtBeginning(UndoRecord.ADD_TO_GROUP, new Object[]{info, object, pos});
        }
    }
