...
public abstract class ToolButton {
     ...
     *
     * @param owner The owner of the button. This allows for specific button behavior depending on
    ...
    /**
     * Returns the button state. The button can be in normal state, highlighted state or selected
     * state.
     */
    public int getState() {
        return state;
    ...
    /**
     * Sets the button as selected. If the button is currently highlighted, selecting it supersedes
    ...
    /**
     * Sets the button as highlighted. Selection precedes over highlighting, so if the button is
     * currently selected, highlighting is ignored.
     */
