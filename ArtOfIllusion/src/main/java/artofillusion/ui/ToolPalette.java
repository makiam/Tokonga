...
/**
 * A ToolPalette is drawn as a grid of images, one for each EditingTool that is added to the
 * palette. It allows a single tool to be selected at any time.
 */
public class ToolPalette extends CustomWidget {
    ...
    /**
     * Create a new ToolPalette. w and h give the width and height of the tool palette, measured in
     * icons.
     */
