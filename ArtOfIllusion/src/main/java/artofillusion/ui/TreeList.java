...
/**
 * This is a Widget which displays a hierarchy of objects. It provides functionality for opening and
 * closing parts of the hierarchy, selecting elements, and moving elements around.
 */
public class TreeList extends CustomWidget {
    ...
    /**
     * Temporarily disable updating of the tree. This is useful when several elements are going to
     * be added or removed at once.
     */
    ...
    /**
     * Get an array of the objects corresponding to visible TreeElements, in the order that they
     * appear.
     */
