...
/**
 * This class presents a user interface for editing the value of a {@link Property}. Given a
 * Property object, it constructs an appropriate Widget based on the type of value it represents and
 * the allowed values. The Widget dispatches a ValueChangedEvent whenever its value changes.
 */
public class PropertyEditor {
    ...
    /**
     * Get the label to display with this component. This may be null, in which case no label should
     * be displayed.
     */
    ...
    /**
     * This is used for events generated by BTextFields for editing String properties. These need to
     * be handled differently, since the property value should only change when editing is complete.
     */
