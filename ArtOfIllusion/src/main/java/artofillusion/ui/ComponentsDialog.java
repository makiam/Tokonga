...
/**
 * A ComponentsDialog is a modal dialog containing a line of text, and one or more Widgets for the
 * user to edit. Each Widget has a label next to it. At the bottom are two buttons labeled OK and
 * Cancel.
 */
