...
/**
 * This class displays a set of handles around a selection in a ViewerCanvas. It processes mouse
 * clicks on them, and translates them into higher level events which are dispatched for further
 * processing, most often by an EditingTool. As the name suggests, this manipulator can display up
 * to nine handles, corresponding to the eight compass points plus center.
 */
public class NinePointManipulator extends EventSource implements Manipulator {
     ...
     *
     * @param images an array of images to use for the nine handles in the following order: NW, N,
     * NE, W, CENTER, E, SW, S, SE. If an element is null, there will not be any handle at the
    ...
    /**
     * This should be invoked when the mouse is pressed. It determines whether the mouse was over a
     * handle, and if so, generates a HandlePressedEvent.
     *
    ...
    /**
     * This should be invoked when the mouse is dragged. If the drag began with the mouse over a
     * handle, this generates a HandleDraggedEvent.
     *
     * @param ev the event which has occurred
     * @param view the ViewerCanvas in which the event occurred
     */
    ...
    /**
     * This should be invoked when the mouse is released. If the drag began with the mouse over a
     * handle, this generates a HandleReleasedEvent.
     *
     * @param ev the event which has occurred
     * @param view the ViewerCanvas in which the event occurred
     */
    ...
    /**
     * Given a bounding box in view coordinates, find the corresponding rectangle in screen
     * coordinates.
     */
    ...
    public class HandleEvent {
        ...
        /**
         * Get the bounding box of the manipulator on screen at the time the mouse was first
         * clicked.
         */
        ...
        /**
         * Get the bounding box in view coordinates of the selection at the time the mouse was first
         * clicked.
         */
