...
/**
 * This is a subclass of EditingTool for tools which edit Mesh objects. It contains common features
 * used by many tools.
 */
public abstract class MeshEditingTool extends EditingTool {
    ...
    /**
     * This method returns a bounding box for the selected vertices in view coordinates, or null if
     * nothing is selected.
     */
