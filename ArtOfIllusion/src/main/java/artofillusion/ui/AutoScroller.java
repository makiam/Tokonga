...
/**
 * This class is attached to a scroll pane. It causes the scroll pane to automatically scroll
 * whenever the mouse is dragged beyond the edge of it.
 */
public class AutoScroller implements Runnable {
    ...
    /**
     * This is called repeatedly whenever the mouse is dragged outside the visible bounds to scroll
     * the BScrollPane. If additional things need to be done at this time (such redrawing objects
     * being dragged), this can be subclassed.
     */
