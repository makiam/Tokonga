...
/**
 * This class displays a set of curves and handles around a selection in a
 * ViewerCanvas. It processes mouse clicks on them, and translates them into
 * higher level events which are dispatched for further processing, most often
 * by an EditingTool. It presents a composite user interface for performing
 * moving, scaling, and rotating operations.
 */
public class Compound3DManipulator extends EventSource implements Manipulator {
    ...
    /**
     * Get whether rotations should be performed around the select center or
     * around the origin.
     */
    ...
    /**
     * Set whether rotations should be performed around the select center or
     * around the origin.
     */
    ...
    /**
     * @deprecated Use setPQNAxes. This method redirects. x -> p, y -> q, z ->
     * n. N stands for 'normal-direction'
     */
    @Deprecated
    ...
    public HandleType getHandleTypeAtLocation(Point location, ViewerCanvas view, BoundingBox selectionBounds) {
        ...
        for (RotationHandle rotHandle : rotHandles) {
            if ((rotSegment = rotHandle.findClickTarget(location, view.getCamera())) != -1) {
                return ROTATE;
            }
        }
     ...
     * @param selectionBounds a BoundingBox enclosing whatever is selected in
     * the canvas
     */
    @Override
    ...
    /**
     * Given a bounding box in view coordinates, find the corresponding
    ...
    /**
     * Instances of this class represent the different view modes for the
     * manipulator.
     */
    ...
    private class RotationHandle {
         ...
         *
         * @param segments The number of segmetns that describe the rotation
         * circle
         ...
         * @param refAxis The axis where arc drawing begins. Used when asking
         * for a rotation feedback polygon
         */
    ...
    /**
     * This is the superclass of the various events generated by the
     * manipulator.
     */
    public class HandleEvent {
        ...
        /**
         * Get the bounding box of the manipulator on screen at the time the
         * mouse was first clicked.
         */
        ...
        /**
         * Get the bounding box in view coordinates of the selection at the time
        ...
        /**
         * Get the original mouse event responsible for this event being
         * generated.
         */
    ...
    public class HandleDraggedEvent extends HandleEvent {
        ...
        /**
         * Get a matrix which can be used to transform objects or vertices from
         * their original positions to their moved, scaled, or rotated
         * positions.
         */
