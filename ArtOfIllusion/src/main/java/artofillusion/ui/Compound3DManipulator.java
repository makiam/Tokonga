 ...
 * processes mouse clicks on them, and translates them into higher level events which are dispatched
 * for further processing, most often by an EditingTool. It presents a composite user interface for
 * performing moving, scaling, and rotating operations.
 */
...
//          }
         ...
         * @param refAxis The axis where arc drawing begins. Used when asking for a rotation
         * feedback polygon
         */
        ...
        /**
         * Given an angle, this method returns a 3D polygon which can be used to tell the user the
         * rotation amount when drawn on the canvas
         *
         * @param angle
    ...
    public class HandleDraggedEvent extends HandleEvent {
        ...
        /**
         * Get a matrix which can be used to transform objects or vertices from their original
         * positions to their moved, scaled, or rotated positions.
         */
