...
public class Compound3DManipulator extends EventSource implements Manipulator {
    ...
    private final HandleType[] boxHandleType;
    ...
    private static final Color handleRed = new Color(255 - 16, 0, 0);
    private static final Color handleGreen = new Color(0, 255 - 16, 0);
    private static final Color handleBlue = new Color(15, 127 - 16, 255);
    ...
    public class HandleEvent {
        ...
        private final BoundingBox selectionBounds;
        private final WidgetMouseEvent event;
