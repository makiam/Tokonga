...
/**
 * This class implements "infinite" mouse drags, which are not restricted by the boundaries of the
 * screen. It is useful when you want to use mouse drags to control something other than the cursor
 * position. It accomplishes this by repeatedly moving the cursor back to the original click
 * position, while generating its own MouseDraggedEvents and MouseReleasedEvents as if the cursor
 * were freely moving over an unbounded screen.
 */
