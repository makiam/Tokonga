...
/**
 * This class implements the dialog box which is used to choose texture mappings for objects. It
 * presents a list of all mappings which can be used with the current object and material, and
...
public class TextureMappingDialog extends BDialog {
    ...
    /**
     * Create a dialog for editing the texture mapping for a particular object. If the object has a
     * layered texture, then layer is the layer number to edit. Otherwise, layer is ignored.
     */
    public TextureMappingDialog(BFrame parent, Object3D obj, int layer) {
        ...
        for (TextureMapping mapping : PluginRegistry.getPlugins(TextureMapping.class)) {
            if (mapping.legalMapping(obj, probe)) {
