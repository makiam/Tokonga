...
public class ObjectTextureDialog extends BDialog implements ListChangeListener {
    ...
    private final ObjectInfo editObj;
    private final BList texList;
    private final BList matList;
    private final BList layerList;
    private final BButton texMapButton;
    private final BButton matMapButton;
    private final BButton addLayerButton;
    private final BButton deleteLayerButton;
    private final BButton moveUpButton;
    private final BButton moveDownButton;
    private final BComboBox newTextureChoice;
    private final BComboBox newMaterialChoice;
    private final BorderContainer texturesTab;
    private final FormContainer texTitlePanel;
    private final FormContainer texListPanel;
    private final FormContainer layerPanel;
    private final FormContainer paramsPanel;
    private final MaterialPreviewer preview;
    private final BComboBox typeChoice;
    private final BComboBox blendChoice;
    private BComboBox[] paramTypeChoice;
    private ValueSelector[] paramValueWidget;
    private int[] fieldParamIndex;
    private final BScrollPane paramsScroller;
    private Runnable callback;
    private final Texture oldTexture;
    private final TextureMapping oldTexMapping;
    final Material oldMaterial;
    final MaterialMapping oldMatMapping;
    private final LayeredTexture layeredTex;
    private final LayeredMapping layeredMap;
    private final ActionProcessor renderProcessor;
    ...
    public ObjectTextureDialog(LayoutWindow parent, ObjectInfo[] objects, boolean includeTextures, boolean includeMaterials) {
        ...
        BorderContainer materialsTab = new BorderContainer();
        if (includeMaterials) {
        ...
        FormContainer matListPanel = new FormContainer(new double[]{1.0}, new double[]{0.0, 1.0, 0.0});
        if (obj.length == 1) {
