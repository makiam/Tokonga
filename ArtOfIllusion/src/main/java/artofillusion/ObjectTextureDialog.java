...
/**
 * This class implements the dialog box which is used to choose textures for objects. It presents a
 * list of all available textures from which the user can select one. If only one object is being
 * editing, it also allows the user to edit the texture mapping for that object.
 */
