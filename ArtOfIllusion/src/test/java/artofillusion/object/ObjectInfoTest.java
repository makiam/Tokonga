...
public class ObjectInfoTest {
    ...
    /**
     * Test objectInfo copy data from other objectInfo and points to same geometry Checks that
     * source empty tracks overwrite existed one
     */
    ...
    /**
     * Test objectInfo copy data from other objectInfo and points to same geometry Checks that
     * source tracks overwrite existed one
     */
    @Test
    ...
    /**
     * Test objectInfo copy data from other objectInfo and points to same geometry Checks that empty
     * distortion data overwrites existed one
     */
    @Test
    ...
    /**
     * Test check that getDistortedObject without distortion returns unchanged object Distorted
     * object is wrapperd with ObjectWrapper
     */
    @Test
