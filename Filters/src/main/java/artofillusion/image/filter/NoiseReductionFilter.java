 ...
 * The algorithm is partly based on the one described in McCool, M. "Anisotropic diffusion for Monte
 * Carlo noise reduction." ACM Transactions on Graphics, vol. 18, no. 2, 1999.
 */
