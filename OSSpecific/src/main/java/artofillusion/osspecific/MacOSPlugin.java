...
/**
 * This is a plugin to make Art of Illusion behave more like a standard Macintosh application when
...
public class MacOSPlugin implements Plugin, InvocationHandler {
    ...
    /**
     * This is an inner class used to provide a minimal menu bar when all windows are closed.
     */
