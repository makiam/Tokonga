...
public class SqrtModule extends ProceduralModule<SqrtModule> {
    ...
    public SqrtModule(Point position) {
        super("Sqrt", new IOPort[]{new IOPort(IOPort.NUMBER, IOPort.INPUT, IOPort.LEFT, "Value", "(0)")},
                new IOPort[]{new IOPort(IOPort.NUMBER, IOPort.OUTPUT, IOPort.RIGHT, "Root")},
                position);
        gradient = new Vec3();
    }
