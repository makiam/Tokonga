...
/**
 * This is a Module which generates fractal turbulence based on Perlin's noise
 * function.
 */
...
public class TurbulenceModule extends ProceduralModule<TurbulenceModule> {
    ...
    public TurbulenceModule(Point position) {
        super(Translate.text("Modules:menu.turbulenceModule"), new IOPort[]{new NumericInputPort(IOPort.LEFT, "X", "(X)"),
