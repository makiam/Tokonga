...
project = 'Art of Illusion'
copyright = '2019, Julian MacDonald and Peter Eastman'
author = 'Julian MacDonald and Peter Eastman'
...
texinfo_documents = [
    (master_doc, 'ArtofIllusion', 'Art of Illusion Documentation',
     author, 'ArtofIllusion', 'One line description of project.',
     'Miscellaneous'),
]
